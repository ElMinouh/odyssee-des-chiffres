...
const _ZONE_INTRO = {
 ...
 // ── matfr (Le Pays des Mots) — région cp ──
 "matfr_cp_1": { "emoji":"🌱", "text":"La Clairière Silencieuse ne laisse échapper aucun bruit, pas même un froissement de feuille. Un faon silencieux se cache, immobile. Plume est sûre qu'un peu de vie va bientôt y revenir." },
 "matfr_cp_2": { "emoji":"🌼", "text":"Le Terrier du Lapin est tout calme, aucun petit pas ne s'y presse. Un lapin chuchoteur n'ose plus faire le moindre bruit. Plume pense qu'un peu d'aide lui redonnera de l'élan." },
 "matfr_cp_3": { "emoji":"💧", "text":"Les canards de la Mare ne cancanent plus du tout. Un caneton muet flotte tristement, silencieux. Plume est certaine que tu sauras lui rendre sa voix." },
 "matfr_cp_4": { "emoji":"🐾", "text":"Sur le Sentier des Bêtes, pas le moindre cri ne résonne. Un blaireau discret se terre, encore plus silencieux que d'habitude. Plume pense qu'un peu d'aide le fera sortir de sa cachette." },
 "matfr_cp_5": { "emoji":"🌈", "text":"Le Grand Chêne Creux ne laisse échapper aucun chuchotement de feuilles. Un hibou silencieux veille tout en haut, immobile. Plume pense qu'un souffle de vie ne tardera pas à revenir." },
 // ── matfr — région ce1 ──
 "matfr_ce1_1": { "emoji":"🍎", "text":"Le Pré aux Mille Choses a perdu tous ses petits noms. Une souris curieuse fouille partout, un peu perdue. Plume voltige, impatiente de retrouver les mots manquants." },
 "matfr_ce1_2": { "emoji":"🍓", "text":"Le Panier Renversé traîne, tout emmêlé, au milieu du pré. Un écureuil farceur s'amuse avec les objets sans les ranger. Plume pense qu'un peu d'ordre lui ferait le plus grand bien." },
 "matfr_ce1_3": { "emoji":"🍯", "text":"Le Jardin des Noms est resté fermé, ses fleurs sans le moindre nom. Une coccinelle savante compte et recompte, un peu perdue. Plume a hâte de voir ce jardin refleurir." },
 "matfr_ce1_4": { "emoji":"🌰", "text":"L'Allée des Images est bien vide, sans le moindre mot pour les nommer. Une pie collectionneuse amasse des images sans savoir les ranger. Plume pense qu'un peu d'aide y mettrait bon ordre." },
 "matfr_ce1_5": { "emoji":"🌸", "text":"Le Sentier des Trouvailles est tout terne, sans le moindre mot tout neuf à découvrir. Un renard chercheur fouine partout, un peu déçu. Plume est sûre qu'il va bientôt trouver ce qu'il cherche." },
 // ── matfr — région ce2 ──
 "matfr_ce2_1": { "emoji":"🌿", "text":"La Colline de l'Écho ne renvoie plus le moindre son. Une chèvre montagnarde grimpe et regrimpe, un peu déçue du silence. Plume pense qu'un peu d'aide lui rendra son écho." },
 "matfr_ce2_2": { "emoji":"🍄", "text":"Le Sentier qui Résonne est tout silencieux, pas la moindre chanson ne s'y entend. Une grenouille chanteuse garde la gorge serrée. Plume pense qu'elle a juste besoin d'un peu d'encouragement." },
 "matfr_ce2_3": { "emoji":"🌳", "text":"Les Trois Sommets restent muets, pas le moindre écho ne s'en échappe. Un aigle royal observe, du haut de son perchoir, silencieux et grave. Plume se demande ce qu'il attend." },
 "matfr_ce2_4": { "emoji":"💧", "text":"La Vallée des Tambours ne bat plus aucun rythme. Un ours tambour reste immobile, comme s'il avait oublié comment jouer. Plume pense qu'un peu d'entrain suffira à le relancer." },
 "matfr_ce2_5": { "emoji":"✨", "text":"Le Pic des Refrains est tout silencieux, sans la moindre mélodie. Une colombe mélodieuse garde le bec fermé, un peu timide. Plume a hâte de l'entendre chanter à nouveau." },
 // ── matfr — région cm1 ──
 "matfr_cm1_1": { "emoji":"🏖️", "text":"La Rive aux Rimes ne clapote plus du tout, silencieuse. Un cygne poète glisse sans un mot, cherchant l'inspiration. Plume pense qu'un peu d'aide lui redonnera des rimes." },
 "matfr_cm1_2": { "emoji":"🌊", "text":"L'Îlot des Reflets est tout terne, sans le moindre mot qui danse à sa surface. Une loutre miroir observe son reflet, silencieuse. Plume est sûre qu'un peu d'aide lui rendra ses mots." },
 "matfr_cm1_3": { "emoji":"🪸", "text":"Le Ponton Chantant ne vibre plus d'aucune musique. Un poisson musicien reste immobile, la mélodie coincée quelque part. Plume pense qu'un peu d'aide suffira à la faire jaillir." },
 "matfr_cm1_4": { "emoji":"🫧", "text":"La Crique des Échos ne répète plus rien du tout, silencieuse. Un dauphin espiègle attend, patient, de pouvoir enfin jouer avec les mots. Plume a hâte de l'entendre rire à nouveau." },
 "matfr_cm1_5": { "emoji":"⭐", "text":"Le Miroir d'Eau reste tout trouble, incapable de refléter le moindre sourire. Une carpe dorée nage lentement dessous, songeuse. Plume pense qu'elle attend justement quelqu'un comme toi." },
 // ── matfr — région cm2 ──
 "matfr_cm2_1": { "emoji":"🌻", "text":"L'Entrée Murmurante ne laisse passer aucun souffle de mots. Une chauve-souris chuchoteuse se tait, blottie dans l'ombre. Plume pense qu'un peu d'aide lui rendra la parole." },
 "matfr_cm2_2": { "emoji":"🍏", "text":"La Galerie des Sons reste muette, pas le moindre écho ne s'y forme. Une salamandre discrète se cache entre les pierres, silencieuse. Plume est sûre qu'un peu d'aide la fera sortir." },
 "matfr_cm2_3": { "emoji":"🌾", "text":"La Source Chuchotante ne murmure plus du tout. Un grillon musicien garde ses pattes immobiles, sans la moindre chanson. Plume pense qu'un peu d'entrain lui redonnera son rythme." },
 "matfr_cm2_4": { "emoji":"🌾", "text":"Le Couloir Bleu ne laisse filtrer aucun son, pas même une berceuse. Un scarabée bleu avance lentement, silencieux. Plume pense qu'un peu d'aide l'aidera à retrouver sa mélodie." },
 "matfr_cm2_5": { "emoji":"🌞", "text":"Dans la Chambre des Murmures, {villain} garde un silence de plomb, tout proche désormais. Un corbeau mystérieux observe, immobile, depuis un recoin sombre. Plume sent que la fin de l'aventure approche." },
 // ── matfr — région final (Le Château des Lettres) ──
 "matfr_final_1": { "emoji":"🌉", "text":"Le Pont des Lettres reste muet, pas la moindre lettre n'y chante encore. Une fée des lettres voltige, un peu hésitante. Plume pense qu'un peu de courage la fera briller à nouveau." },
 "matfr_final_2": { "emoji":"🗼", "text":"La Tour de l'Alphabet est étrangement silencieuse, ses lettres endormies. Un lion des lettres somnole au pied de la tour, imposant mais paisible. Plume pense qu'il n'attend qu'un signal pour se réveiller." },
 "matfr_final_3": { "emoji":"🅰️", "text":"La Salle du Grand A est plongée dans le silence, sa grande lettre éteinte. Une tisseuse de lettres travaille discrètement dans un coin, concentrée. Plume se demande ce qu'elle prépare." },
 "matfr_final_4": { "emoji":"🪜", "text":"L'Escalier des Mots reste immobile, ses marches muettes. Une tortue des mots grimpe lentement, une lettre à la fois. Plume pense qu'un peu d'aide accélérerait bien les choses." },
 "matfr_final_5": { "emoji":"📖", "text":"Le Donjon du Conteur est tout proche du silence de {villain}, gardien de la toute dernière page du Livre. Le Gardien du Grand Livre veille, grave, sur ce dernier passage. Plume sent que la fin de l'aventure est toute proche." },
 // ── prim (Calcultopia) ──
 "plaine": { "emoji":"🌾", "text":"La Plaine des Débuts semble un peu perdue dans le brouillard. Un berger compte et recompte ses moutons sans jamais trouver le bon nombre. Un loup rôde non loin, attiré par la confusion." },
 "village": { "emoji":"🏡", "text":"Le Village Joyeux n'a plus rien de joyeux : les numéros des maisons se sont tous emmêlés. Un coq gigantesque s'énerve au milieu de la place, dérangé par ce désordre." },
 "prairie": { "emoji":"🌻", "text":"Dans la Prairie Fleurie, les tournesols pointent chacun dans une direction différente, complètement perdus. La Reine des Abeilles bourdonne, agacée par ce désordre floral." },
 "bonbons": { "emoji":"🍭", "text":"Le Pays des Bonbons est envahi d'une brume sucrée et collante. Un Donut Maléfique trône au milieu, gonflé de calculs faux qu'il refuse de corriger." },
 "foret": { "emoji":"🌲", "text":"La Forêt Enchantée est étrangement silencieuse, comme figée par le brouillard du Comte Zéro. Un dragon somnole entre les arbres, et Lumo semble troublée, comme si cet endroit lui rappelait vaguement quelque chose." },
 "champignons": { "emoji":"🍄", "text":"Dans la Vallée des Champignons, une famille de hérissons n'arrive plus à s'accorder sur le nombre de leurs épines. Un escargot géant, lui, prend tout son temps pour s'en préoccuper." },
 "trolls": { "emoji":"⛺", "text":"Un rire glacial résonne entre les arbres de la Forêt des Trolls. Un Grand Troll bloque le passage, sûr de lui — comme si {villain} en personne l'avait prévenu de ton arrivée." },
 "plage": { "emoji":"🏖️", "text":"Sur la Plage Ensoleillée, les coquillages sont éparpillés n'importe comment. Un vieux crabe royal s'agace, incapable de retrouver son fameux classement du plus petit au plus grand." },
 "desert": { "emoji":"🏜️", "text":"Le Désert de Feu est balayé par le brouillard du Comte Zéro. Un marchand de tapis n'arrive plus à compter son or correctement. Un scorpion géant guette, profitant de la confusion générale." },
 "plaines_venteuses": { "emoji":"🌬️", "text":"Sur les Plaines Venteuses, le Sergent Virgule s'agite, débordé par des calculs qui ne tombent jamais juste. Un bison tonnerre gronde au loin, prêt à foncer si personne ne vient mettre de l'ordre." },
 "temple": { "emoji":"🏛️", "text":"Les hiéroglyphes du Temple Antique sont tout mélangés, comme si le temps lui-même s'était emmêlé les pinceaux. Un gardien de pierre veille, immobile, attendant que quelqu'un remette enfin de l'ordre." },
 "profondeurs": { "emoji":"🌊", "text":"Dans les Profondeurs Océanes, un ancien chant marin s'est tu, étouffé par le silence du brouillard. Un kraken abyssal remue les eaux troubles, agité par ce calme inhabituel." },
 "glace": { "emoji":"❄️", "text":"Les Pics de Glace sont pris dans un froid glacial qui ne veut pas céder. Un géant de glace se dresse, aussi figé que les calculs qui bloquent tout le passage." },
 "marais": { "emoji":"🐊", "text":"Le Marais Lugubre est plus sombre que jamais, comme si {villain} sentait le danger approcher. Une hydre marécageuse surveille les environs, nerveuse, prête à défendre son territoire." },
 "forteresse": { "emoji":"🏰", "text":"Les bannières de la Forteresse Médiévale pendent, déchirées et sans couleur. Un dragon cuirassé monte la garde, aussi rigide que les remparts qu'il protège." },
 "sakura": { "emoji":"🌸", "text":"Le Mont Sakura est étrangement silencieux, pas un seul pétale ne tombe des cerisiers. Un maître ninja médite, immobile, gardien discret de ce lieu paisible." },
 "nocturne": { "emoji":"🌙", "text":"La nuit du Royaume Nocturne est particulièrement épaisse, presque impénétrable. Un seigneur des ombres y règne, invisible, profitant de cette obscurité pour brouiller tous les calculs." },
 "volcan": { "emoji":"🌋", "text":"La lave du Volcan Maudit bouillonne sans relâche. Un seigneur des flammes y règne en maître, sûr que personne n'osera s'aventurer jusqu'à lui. Lumo sent que la fin approche." },
 "espace": { "emoji":"🌌", "text":"Dans la Galaxie Infinie, une étoile s'est éteinte, comme absorbée par le brouillard du Comte Zéro. Un alien quantique flotte non loin, aussi imprévisible que les nombres qui dansent autour de lui." },
 "cimes": { "emoji":"⛰️", "text":"Le vent souffle fort sur les Cimes Vertigineuses, comme s'il portait une nouvelle inquiétante jusqu'à {villain}. Un roc empereur veille, massif, au sommet du chemin." },
 "mecanique": { "emoji":"⚙️", "text":"Les rouages de la Cité Mécanique sont tous grippés, bloqués par des calculs qui ne s'enclenchent plus. Un mecha suprême reste figé au milieu des engrenages silencieux." },
 "ile": { "emoji":"🏝️", "text":"L'Île Mystérieuse cache un vieux capitaine fantôme, bien décidé à garder son trésor de calculs embrouillés. Lumo sent que {villain} n'est plus très loin, désormais." },
 "sanctuaire": { "emoji":"⛩️", "text":"Le Sanctuaire Final s'élève devant toi, enveloppé du dernier voile de brouillard. C'est ici, tout au fond, que {villain} garde jalousement le Cristal de l'Unité. Lumo se serre contre toi, sachant que le vrai combat commence maintenant." },
 // ── primfr (Verbopolis) ──
 "primfr_plaine": { "emoji":"🌾", "text":"Les Faubourgs de Verbopolis ont perdu presque tous leurs mots, réduits à des borborygmes confus. Un écho vagabond erre dans les rues, répétant sans cesse des phrases qui n'ont plus de sens." },
 "primfr_village": { "emoji":"🏡", "text":"La Place des Lettres est couverte de panneaux mal orthographiés, dans tous les sens. Une cloche bavarde sonne n'importe quand, incapable de dire l'heure correctement." },
 "primfr_prairie": { "emoji":"🌻", "text":"Dans l'Allée des Voyelles, les sons se sont tous emmêlés, impossibles à distinguer. Un Grand A facétieux se moque de la confusion, changeant de forme dès qu'on l'approche." },
 "primfr_bonbons": { "emoji":"🍭", "text":"Le Marché aux Syllabes est étrangement silencieux, ses étals vides de mots à vendre. Un camelot des syllabes tente de vendre des mots à moitié cassés, sans grand succès." },
 "primfr_foret": { "emoji":"🌲", "text":"La Rue des Libraires est plongée dans un silence de bibliothèque abandonnée. Un libraire fantôme hante les rayonnages vides, cherchant désespérément des livres qui ont perdu leurs pages." },
 "primfr_champignons": { "emoji":"🍄", "text":"Le Passage des Conteurs n'a plus une seule histoire à raconter. Un vieux conteur masqué erre, incapable de terminer la moindre phrase sans se perdre en chemin." },
 "primfr_trolls": { "emoji":"⛺", "text":"Un rire glacial résonne dans l'Impasse des Syllabes Perdues. Un troll y garde jalousement des syllabes égarées, refusant de les rendre à qui que ce soit." },
 "primfr_plage": { "emoji":"🏖️", "text":"Les Quais de la Lecture sont silencieux, sans le moindre livre ouvert. Un moussaillon lettré cherche à grand-peine à déchiffrer une carte au trésor, sans y parvenir." },
 "primfr_desert": { "emoji":"🏜️", "text":"Les Halles aux Mots sont désertes, leurs étiquettes toutes mélangées. Un marchand de mots rares peine à retrouver le bon prix pour chacun de ses trésors linguistiques." },
 "primfr_plaines_venteuses": { "emoji":"🌬️", "text":"Le Jardin des Synonymes est en piteux état, ses mots proches tout emmêlés entre eux. Un jardinier s'arrache les cheveux, incapable de les remettre dans le bon ordre." },
 "primfr_temple": { "emoji":"🏛️", "text":"La Grande Bibliothèque est sens dessus dessous, ses livres éparpillés sans le moindre classement. Un gardien de pierre veille, impassible, attendant qu'on remette enfin de l'ordre." },
 "primfr_profondeurs": { "emoji":"🌊", "text":"Dans les Souterrains du Sens, les mots ont perdu toute signification, réduits à un écho confus. Un fouilleur de sens y creuse sans relâche, cherchant désespérément un peu de clarté." },
 "primfr_glace": { "emoji":"❄️", "text":"Le Quartier des Horloges est figé, ses aiguilles bloquées par un froid mordant. Un grand horloger gelé s'active en vain, incapable de faire repartir le moindre mécanisme." },
 "primfr_marais": { "emoji":"🐊", "text":"La Gare des Temps est plongée dans le chaos, les trains de verbes partant n'importe quand. Un chef de gare temporel s'égosille, dépassé par tous ces horaires embrouillés." },
 "primfr_forteresse": { "emoji":"🏰", "text":"La Tour des Verbes penche dangereusement, ses conjugaisons toutes de travers. Un seigneur des verbes s'y accroche, refusant que quiconque vienne redresser les choses." },
 "primfr_sakura": { "emoji":"🌸", "text":"Le Beffroi des Conjugaisons ne sonne plus jamais à l'heure, désaccordé depuis trop longtemps. Un sonneur s'y épuise, incapable de retrouver le bon rythme." },
 "primfr_nocturne": { "emoji":"🌙", "text":"L'Observatoire du Temps est plongé dans une nuit sans étoiles. Un astronome du temps scrute le ciel en vain, cherchant le moindre signe de lumière." },
 "primfr_volcan": { "emoji":"🌋", "text":"L'Imprimerie du Scribe Noir crache sans relâche des pages pleines de fautes. Le Scribe Noir y travaille sans repos, fier de son œuvre bâclée." },
 "primfr_espace": { "emoji":"🌌", "text":"Les Toits de la Syntaxe sont tout de travers, sujets et verbes éparpillés n'importe où. Un acrobate s'y faufile, jonglant tant bien que mal avec des mots qui refusent de s'aligner." },
 "primfr_cimes": { "emoji":"⛰️", "text":"Le Grand Pont des Mots est à moitié effondré, ses planches de phrases toutes disjointes. Un gardien du pont refuse le passage, certain que {villain} ne tolérera aucune réparation." },
 "primfr_mecanique": { "emoji":"⚙️", "text":"L'Atelier des Phrases est un vrai capharnaüm, sujets et compléments éparpillés partout. Un mécanicien des phrases s'active, dépassé par l'ampleur du désordre." },
 "primfr_ile": { "emoji":"🏝️", "text":"La Citadelle de la Phrase tient à peine debout, ses derniers remparts prêts à s'effondrer. Un commandant y veille farouchement, sentant que {villain} n'est plus très loin." },
 "primfr_sanctuaire": { "emoji":"📚", "text":"L'Antre du Docteur Babel s'ouvre enfin devant toi, silencieux et menaçant. C'est ici que dort le secret de la langue perdue de Verbopolis. Zoé et Malo échangent un regard grave : le vrai combat commence maintenant." },
 // ── primhist (l'atelier d'Isidore) ──
 "primhist_plaine": { "emoji":"🔥", "text":"La Clairière du Foyer est étrangement froide, comme si le feu n'y avait jamais brûlé. Un gardien du feu sacré veille, inquiet, sur des braises qui refusent de s'allumer." },
 "primhist_village": { "emoji":"🏕️", "text":"Le Campement des Chasseurs semble figé dans le temps, comme abandonné en pleine action. Un chef chasseur observe les environs, méfiant face à ce silence inhabituel." },
 "primhist_prairie": { "emoji":"🦣", "text":"La Plaine aux Mammouths est étrangement vide, sans la moindre trace de troupeau. Un mammouth ancestral erre, seul, cherchant en vain les siens." },
 "primhist_bonbons": { "emoji":"🎨", "text":"La Grotte aux Peintures est plongée dans une obscurité totale, ses parois muettes. Un peintre des cavernes s'active dans le noir, incapable de terminer son œuvre." },
 "primhist_foret": { "emoji":"🏺", "text":"Les Rives du Nil sont étrangement sèches, comme si le fleuve avait oublié de monter. Un gardien du Nil scrute l'horizon, inquiet de ce retard inhabituel." },
 "primhist_champignons": { "emoji":"🏗️", "text":"Le Chantier de Gizeh est étrangement silencieux, pas un seul bloc de pierre ne bouge. Un pharaon bâtisseur s'impatiente, ses plans de construction tout emmêlés." },
 "primhist_trolls": { "emoji":"🪦", "text":"La Vallée des Tombeaux garde un silence pesant, ses secrets bien enfouis. Une momie vengeresse veille sur ces trésors, sentant que l'Horloger observe de près." },
 "primhist_plage": { "emoji":"⚓", "text":"Le Port de Thèbes est désespérément calme, sans le moindre bateau à l'horizon. Un amiral s'y morfond, attendant des marchandises qui ne semblent jamais arriver." },
 "primhist_desert": { "emoji":"🏛️", "text":"La Voie Appienne s'étend, désertée, sous un soleil de plomb. Un légionnaire vétéran monte la garde, seul, se demandant où sont passés tous les voyageurs." },
 "primhist_plaines_venteuses": { "emoji":"🏟️", "text":"Le Forum Romain est étrangement silencieux, sans le moindre débat. Un sénateur orateur s'impatiente, cherchant désespérément un public pour l'écouter." },
 "primhist_temple": { "emoji":"🏛️", "text":"Le Circus Maximus est vide, ses gradins désespérément silencieux. Un gladiateur invaincu attend, seul, un adversaire qui ne semble jamais venir." },
 "primhist_profondeurs": { "emoji":"♨️", "text":"Les Thermes de Caracalla sont étrangement froids, leurs bassins vidés de toute vapeur. Un gardien des thermes s'inquiète, incapable de raviver le moindre feu." },
 "primhist_glace": { "emoji":"❄️", "text":"Les Remparts d'Hiver craquent sous un froid mordant, prêts à céder. Un chevalier des neiges monte la garde, transi, mais déterminé à tenir bon." },
 "primhist_marais": { "emoji":"🌫️", "text":"Le Marécage du Fief est plongé dans une brume épaisse, pleine de rumeurs inquiétantes. Une sorcière y prépare ses potions, méfiante, sentant que l'Horloger n'est jamais loin." },
 "primhist_forteresse": { "emoji":"🏰", "text":"Le Château Assiégé résonne encore du fracas des combats. Un seigneur assiégé refuse de se rendre, retranché derrière ses derniers remparts." },
 "primhist_sakura": { "emoji":"🎪", "text":"La Foire Médiévale est étrangement terne, sans la moindre musique ni couleur. Un bouffon du roi tente vainement de faire rire une foule qui n'est pas au rendez-vous." },
 "primhist_nocturne": { "emoji":"🌙", "text":"La Veillée des Gardes s'étire, interminable, dans une nuit qui semble ne jamais vouloir finir. Un capitaine de nuit lutte contre le sommeil, épuisé par cette attente sans fin." },
 "primhist_volcan": { "emoji":"⚒️", "text":"Les Forges de la Révolution grondent, prêtes à s'emballer. Un forgeron révolutionnaire s'active fébrilement, sentant qu'une époque entière est sur le point de basculer." },
 "primhist_espace": { "emoji":"🎈", "text":"Le Ciel de 1889 reste étrangement vide, sans la moindre tour à l'horizon. Un aéronaute intrépide scrute les nuages, impatient de voir enfin s'élever quelque chose de nouveau." },
 "primhist_cimes": { "emoji":"🏭", "text":"Les Ateliers du Progrès sont étrangement silencieux, leurs machines à l'arrêt. Un ingénieur visionnaire s'active, sentant que l'Horloger presse le pas quelque part au loin." },
 "primhist_mecanique": { "emoji":"🚂", "text":"La Gare à Vapeur reste muette, sans la moindre locomotive prête à partir. Un chef mécanicien s'active en vain, incapable de faire souffler la moindre vapeur." },
 "primhist_ile": { "emoji":"💡", "text":"Le Salon des Inventeurs est étrangement calme, ses tables couvertes de plans inachevés. Un inventeur fou s'agite, sentant que la dernière page de ton carnet approche." },
 "primhist_sanctuaire": { "emoji":"⚙️", "text":"L'Atelier d'Autrefois s'ouvre enfin devant toi, chargé de tous les souvenirs de Grand-père Isidore. C'est ici que l'Horloger garde le tout dernier engrenage du temps. Ton carnet en main, tu sens que cette dernière page va enfin s'écrire." },
 // ── col (Sidéris) ──
 "col_cp_1": { "emoji":"⚓", "text":"Le Port des Décimales est en plein chaos, les décimales de chaque marchandise dansant n'importe où. Un gardien des virgules erre, dépassé, incapable de les remettre à leur place." },
 "col_cp_2": { "emoji":"🏪", "text":"Au Quai des Marchands, les comptes ne tombent jamais juste, chaque transaction plus fausse que la précédente. Un écumeur décimal profite du désordre pour arrondir les additions à son avantage." },
 "col_cp_3": { "emoji":"🗼", "text":"Le Phare Brisé ne projette plus qu'une lumière vacillante, ses calculs de distance tout faussés. Un spectre y erre, hanté par des décimales qu'il n'arrive plus à aligner." },
 "col_cp_4": { "emoji":"🪨", "text":"Le Récif Trompeur cache ses dangers sous des mesures truquées. Une mâchoire tapie dans les bas-fonds attend, profitant de chaque calcul mal posé pour surprendre les navires." },
 "col_cp_5": { "emoji":"🕳️", "text":"La Fosse aux Nombres semble sans fond, ses décimales s'enfonçant toujours plus loin dans la confusion. Une hydre des profondeurs y prospère, se nourrissant du désordre ambiant." },
 "col_ce1_1": { "emoji":"🕳️", "text":"Les Cavernes Fractionnaires résonnent de parts mal réparties, jamais égales. Une reine y règne, jalouse de ses fractions, refusant de partager quoi que ce soit équitablement." },
 "col_ce1_2": { "emoji":"🌲", "text":"Le Bois des Numérateurs est sens dessus dessous, chaque numérateur séparé de son dénominateur. Un loup alpha y rôde, aussi indomptable que ces fractions éclatées." },
 "col_ce1_3": { "emoji":"🥧", "text":"Le Sentier Partagé est bloqué, ses parts réparties n'importe comment. Un troll diviseur garde le passage, refusant tout partage tant que les calculs ne seront pas justes." },
 "col_ce1_4": { "emoji":"🗣️", "text":"La Grotte aux Échos répète sans cesse les mêmes menaces, comme un calcul erroné en boucle. Un maître des ombres s'y cache, se nourrissant de cette confusion sonore." },
 "col_ce1_5": { "emoji":"🐉", "text":"Le Cœur de la Forêt cache un dragon replié sur lui-même, gardien de fractions trop compliquées pour quiconque. Il refuse d'en céder la moindre part." },
 "col_ce2_1": { "emoji":"🧊", "text":"Le Plateau des Relatifs est plongé dans un froid mordant, les nombres négatifs s'y accumulant sans limite. Une sentinelle glaciale veille, aussi inflexible que ce climat hostile." },
 "col_ce2_2": { "emoji":"➖", "text":"La Faille Négative s'élargit un peu plus chaque jour, engloutissant tout nombre positif qui s'en approche. Une ombre du moins y règne, se nourrissant de ce vide grandissant." },
 "col_ce2_3": { "emoji":"⛰️", "text":"La Crête des Signes est instable, les plus et les moins s'y inversant sans prévenir. Un roc massif garde le sommet, aussi imprévisible que ces signes changeants." },
 "col_ce2_4": { "emoji":"🧊", "text":"Le Glacier Gradué dérive lentement, ses graduations toutes faussées. Une wyverne polaire plane au-dessus, indifférente à la dérive qu'elle alimente." },
 "col_ce2_5": { "emoji":"🕳️", "text":"Le Pic du Zéro surplombe un abîme sans fond, où tout nombre semble s'annuler. Un titan y sommeille, gardien silencieux de ce point d'équilibre instable." },
 "col_cm1_1": { "emoji":"🏯", "text":"La Citadelle Algébrique reste close, ses portes verrouillées par des inconnues jamais résolues. Un gardien veille, refusant tout passage tant que x restera un mystère." },
 "col_cm1_2": { "emoji":"🗿", "text":"La Salle des Variables est instable, chaque lettre changeant de valeur sans prévenir. Une gargouille littérale s'y perche, aussi imprévisible que ces variables changeantes." },
 "col_cm1_3": { "emoji":"⚒️", "text":"La Forge des Identités surchauffe, ses formules remarquables toutes déformées par la chaleur. Un colosse s'y dresse, aussi rigide que les identités qu'il protège." },
 "col_cm1_4": { "emoji":"📚", "text":"La Bibliothèque Secrète cache des équations que personne n'ose plus résoudre. Une liche y veille depuis trop longtemps, gardienne austère de ces vieux grimoires." },
 "col_cm1_5": { "emoji":"🐲", "text":"Le Donjon du Calcul est verrouillé par des équations si complexes que nul n'ose plus s'y aventurer. Un dragon algébrique y sommeille, indifférent à quiconque échoue avant lui." },
 "col_cm2_1": { "emoji":"🏔️", "text":"Les Gorges de Pythagore résonnent d'un écho instable, comme si chaque triangle avait perdu sa mesure. Un gardien veille sur les hypoténuses, refusant qu'on les calcule à la légère." },
 "col_cm2_2": { "emoji":"◻️", "text":"La Crête des Carrés est toute déformée, ses angles ne faisant plus jamais 90 degrés. Un scorpion géomètre y rôde, profitant de cette géométrie corrompue." },
 "col_cm2_3": { "emoji":"🌉", "text":"Le Pont des Racines menace de s'effondrer, ses fondations calculées de travers. Un drake garde les diagonales, aussi instable que le pont qu'il surveille." },
 "col_cm2_4": { "emoji":"🌋", "text":"La Caldeira Brûlante bouillonne sans relâche, chaque cathète calculée trop vite, trop mal. Un colosse s'y dresse, à l'épreuve de la chaleur comme des erreurs de calcul." },
 "col_cm2_5": { "emoji":"🐉", "text":"Le Cœur du Volcan abrite un dragon ancien, gardien ultime des théorèmes de cette région. Il attend, certain qu'aucun raisonnement ne saura le vaincre." },
 "col_final_1": { "emoji":"🔭", "text":"L'Observatoire des Fonctions scrute un ciel presque éteint, ses courbes toutes corrompues par Léthéas. Un gardien veille sur ce qui reste des graphiques, espérant qu'on vienne enfin les réparer." },
 "col_final_2": { "emoji":"🌌", "text":"La Nébuleuse Affine dérive sans direction claire, ses droites ayant perdu toute pente. Un spectre linéaire y erre, incapable de retrouver le moindre repère." },
 "col_final_3": { "emoji":"🖼️", "text":"Le Champ des Images est vide, chaque valeur ayant perdu son antécédent. Un titan y veille, gardien solennel de ce lien rompu entre les nombres." },
 "col_final_4": { "emoji":"🌀", "text":"La Spirale du Calcul tourne sans fin, ses équations s'enchaînant sans jamais se résoudre. Une comète y file, insaisissable, laissant derrière elle un sillage d'inconnues." },
 "col_final_5": { "emoji":"🌠", "text":"Le Sanctuaire Stellaire abrite le dernier gardien des fonctions de cet observatoire. Un souverain y trône, certain qu'aucune courbe ne lui échappera plus." },
 "col_titan_1": { "emoji":"🌑", "text":"Le Seuil de Cendres marque l'entrée du repaire de Léthéas, où plus rien ne semble avoir de mémoire. Un veilleur de l'oubli garde ce passage, aussi implacable que le silence qui règne ici." },
 "col_titan_2": { "emoji":"⭐", "text":"La Galerie des Étoiles Mortes n'abrite plus que des lumières éteintes depuis longtemps. Un phénix de cendre y couve, attendant un signe pour renaître ou pour sombrer définitivement." },
 "col_titan_3": { "emoji":"👑", "text":"Le Trône de l'Oubli s'élève devant toi, plongé dans un silence absolu. C'est ici que Léthéas, Titan de l'Oubli, attend son ultime affrontement. Elara resserre sa cape, grave : le moment est enfin venu." },
 // ── colfr (Monotonia) ──
 "colfr_col_cp_1": { "emoji":"🌊", "text":"Le Fleuve des Langues est presque à sec, son cours ralenti par des siècles de mots oubliés. Un passeur y attend, immobile, incapable de traverser sans les bons mots pour guider sa barque." },
 "colfr_col_cp_2": { "emoji":"🏛️", "text":"Les Ruines Latines gisent silencieuses, leurs inscriptions à moitié effacées. Un centurion oublié y monte une garde solitaire, fidèle à des ordres que plus personne ne comprend." },
 "colfr_col_cp_3": { "emoji":"🌳", "text":"Le Bois Gaulois a perdu toutes ses rumeurs de voix libres. Un druide s'y recueille, cherchant en vain les mots anciens que la forêt semble avoir oubliés." },
 "colfr_col_cp_4": { "emoji":"⛪", "text":"Le Cloître des Moines est plongé dans un silence de pierre, aucun chant ne s'en échappe. Un moine copiste y travaille sans relâche, incapable de terminer le moindre manuscrit." },
 "colfr_col_cp_5": { "emoji":"💧", "text":"La Source du Verbe s'est tarie, ne laissant qu'un filet d'eau trouble. Une gardienne veille sur ce qu'il en reste, espérant qu'elle jaillisse à nouveau, claire." },
 "colfr_col_ce1_1": { "emoji":"💎", "text":"La Caverne aux Mille Reflets a perdu tout son éclat, ses mots dispersés dans l'obscurité. Un écho aux mille voix s'y répercute, confus, incapable de dire une seule chose clairement." },
 "colfr_col_ce1_2": { "emoji":"🌳", "text":"Le Verger des Familles ne porte plus aucun fruit de mots, ses branches nues. Un jardinier des racines s'y active, cherchant désespérément à retrouver les liens perdus entre les mots." },
 "colfr_col_ce1_3": { "emoji":"🏪", "text":"Le Marché des Synonymes est désert, chaque mot ayant perdu son double. Une marchande y attend, seule, avec des étals vides de sens à échanger." },
 "colfr_col_ce1_4": { "emoji":"🗂️", "text":"La Galerie des Registres est sens dessus dessous, plus personne ne sachant qui parle à qui. Un conservateur s'y affaire, dépassé par ce désordre de tons et de niveaux de langue." },
 "colfr_col_ce1_5": { "emoji":"🔮", "text":"Le Prisme du Sens ne diffuse plus aucune lumière, ses couleurs de significations toutes ternes. Un gardien veille, immobile, espérant qu'on vienne enfin le faire irradier à nouveau." },
 "colfr_col_ce2_1": { "emoji":"🏛️", "text":"L'Agora est étrangement silencieuse, sans le moindre débat pour l'animer. Un sophiste y erre, cherchant en vain un adversaire digne de ses arguments." },
 "colfr_col_ce2_2": { "emoji":"🎙️", "text":"La Tribune des Orateurs reste vide, aucun discours ne s'y élève. Un tribun s'y exerce seul, ses arguments tombant dans le silence le plus complet." },
 "colfr_col_ce2_3": { "emoji":"🎭", "text":"L'Amphithéâtre est désespérément silencieux, ses gradins vides de tout public. Un rhéteur masqué y répète son discours, sans personne pour l'écouter ni le contredire." },
 "colfr_col_ce2_4": { "emoji":"🏟️", "text":"Le Forum du Débat est étrangement calme, aucun camp n'osant plus prendre la parole. Un consul y préside, seul, un débat qui n'a jamais vraiment commencé." },
 "colfr_col_ce2_5": { "emoji":"🔥", "text":"La Flamme de Cicéron vacille, presque éteinte, comme si l'éloquence elle-même s'essoufflait. Une ombre veille sur cette dernière lueur, refusant qu'on la ravive." },
 "colfr_col_cm1_1": { "emoji":"🏙️", "text":"La Cité-Horlogerie a perdu son tic-tac régulier, ses rouages de mots tous désynchronisés. Un horloger du verbe s'y active fébrilement, incapable de remettre le temps des phrases à l'heure." },
 "colfr_col_cm1_2": { "emoji":"⚙️", "text":"Les Grands Engrenages du verbe grincent, désaccordés, refusant de s'emboîter correctement. Un maître des engrenages s'y épuise, dépassé par ce mécanisme grammatical déréglé." },
 "colfr_col_cm1_3": { "emoji":"⏳", "text":"La Salle des Temps est en plein chaos, passé, présent et futur tout emmêlés. Un chronographe vivant s'y débat, incapable de remettre chaque verbe à sa bonne époque." },
 "colfr_col_cm1_4": { "emoji":"🌉", "text":"Le Pont des Subordonnées menace de s'effondrer, ses phrases mal reliées entre elles. Un architecte y travaille sans relâche, cherchant la structure qui tiendra enfin bon." },
 "colfr_col_cm1_5": { "emoji":"⚙️", "text":"Le Cœur de la Machine s'est arrêté de battre, privé du rythme des mots qui l'animaient. Un cœur mécanique gît, immobile, attendant qu'on lui redonne vie." },
 "colfr_col_cm2_1": { "emoji":"🎭", "text":"Le Théâtre-Monde est plongé dans le noir, son rideau désespérément baissé. Un metteur en scène s'y agite dans l'ombre, incapable de faire lever le rideau sur la moindre scène." },
 "colfr_col_cm2_2": { "emoji":"🎭", "text":"La Galerie des Masques cache des visages qu'on ne distingue plus, tous identiques dans la pénombre. Un marionnettiste s'y active, brouillant volontairement chaque identité." },
 "colfr_col_cm2_3": { "emoji":"🗣️", "text":"La Scène aux Mille Voix ne produit plus qu'un brouhaha confus, aucune voix ne se distinguant des autres. Un ventriloque fantôme s'y amuse, mélangeant tous les timbres à plaisir." },
 "colfr_col_cm2_4": { "emoji":"🪞", "text":"Le Cabinet des Miroirs brouille tous les reflets, rendant impossible de distinguer le vrai du faux. Un reflet trompeur s'y multiplie, se jouant de quiconque s'y aventure." },
 "colfr_col_cm2_5": { "emoji":"⭐", "text":"L'Étoile des Genres a perdu tout son éclat, masculin et féminin s'y confondant sans logique. Une étoile polymorphe y scintille faiblement, changeant de forme sans jamais se fixer." },
 "colfr_col_final_1": { "emoji":"🏙️", "text":"Les Faubourgs Gris s'étendent, uniformes et sans vie, exactement comme Monotonia les veut. Une sentinelle grise y patrouille, veillant à ce que rien ne dépasse jamais de l'ordre établi." },
 "colfr_col_final_2": { "emoji":"🤫", "text":"La Place du Silence porte bien son nom : pas un mot n'y est prononcé depuis des lustres. Un gardien du silence y veille, intraitable, prêt à faire taire la moindre parole." },
 "colfr_col_final_3": { "emoji":"🏚️", "text":"Les Toits de Monotonia s'étendent à perte de vue, tous identiques, tous gris. Un surveillant y patrouille sans relâche, à l'affût du moindre mot qui oserait sortir du rang." },
 "colfr_col_final_4": { "emoji":"🎙️", "text":"La Grande Tribune ne diffuse plus que des discours creux, vidés de tout sens. Un ministre y pérore sans fin, certain que personne n'osera jamais le contredire." },
 "colfr_col_final_5": { "emoji":"🌅", "text":"L'Aube du Verbe peine à se lever, retenue par une censure implacable. Le Dernier Censeur y veille, déterminé à ce que rien de nouveau ne voie jamais le jour." },
 "colfr_col_titan_1": { "emoji":"🏰", "text":"Le Palais de Cendre marque l'entrée du repaire du Chancelier, où plus aucun mot libre n'ose s'aventurer. Un garde en verrouille l'accès, aussi rigide que le silence qu'il protège." },
 "colfr_col_titan_2": { "emoji":"📜", "text":"La Galerie des Mots Morts n'abrite plus que des pages vides, tous les mots oubliés depuis longtemps. Un archiviste y veille, gardien mélancolique de ce cimetière de langue." },
 "colfr_col_titan_3": { "emoji":"👑", "text":"Le Trône du Chancelier s'élève devant toi, plongé dans un silence pesant. C'est ici qu'Ulrich Morne règne sur Monotonia. Solène serre ton bras, grave : le moment est enfin venu." },
};
...
const _LORE_FRAGMENTS = {
 ...
 // v12.6.0 (session 21, ADR-112 — extension) : Odyssée 2/7. Même esprit que
 // 'mat' (ton tendre, curiosité pure), thématisé autour du silence/des mots
 // retrouvés propre au Grand Livre du Conteur.
 matfr: [
  {id:'matfr_lore_1', type:'zone', zoneId:'matfr_cp_1', emoji:'🍃', title:'La feuille qui ne fait aucun bruit',
   text:"Dans la Clairière Silencieuse pousse une toute petite feuille, différente de toutes les autres. Même quand le vent souffle fort, elle ne fait jamais le moindre bruit en tombant. Les petits animaux du coin l'appellent affectueusement « la sage », parce qu'elle sait garder les secrets mieux que personne."},
  {id:'matfr_lore_2', type:'map', zoneId:'matfr_cp_3', emoji:'🦆', title:'Le nid de plumes oublié',
   text:"Au bord de la Mare aux Canards, un vieux nid tout doux flotte encore, abandonné depuis des saisons. Personne ne sait à quelle famille il appartenait, mais chaque printemps, une nouvelle petite famille vient s'y installer, comme si le nid les attendait depuis toujours."},
  {id:'matfr_lore_3', type:'zone', zoneId:'matfr_ce1_1', emoji:'🌼', title:'La fleur aux mille couleurs',
   text:"Au milieu du Pré aux Mille Choses pousse une fleur si particulière qu'elle change un peu de couleur chaque jour. Personne n'a jamais deviné de quelle couleur elle sera le lendemain. Les papillons du pré adorent cette petite surprise, et viennent la visiter tous les matins."},
  {id:'matfr_lore_4', type:'map', zoneId:'matfr_ce1_4', emoji:'🖼️', title:'Le cadre vide',
   text:"Tout au bout de l'Allée des Images pend un vieux cadre en bois, resté vide depuis toujours. On raconte que la première image qui s'y glissera restera pour toujours la plus belle de toutes. En attendant, les oiseaux du coin aiment beaucoup s'y poser."},
  {id:'matfr_lore_5', type:'zone', zoneId:'matfr_ce2_1', emoji:'🗻', title:'Le caillou qui répond deux fois',
   text:"Sur la Colline de l'Écho, un petit caillou tout rond répond toujours deux fois plus fort que tous les autres. Personne ne sait pourquoi, mais les enfants d'ici adorent lui crier des bonjours, rien que pour l'entendre répondre en double, comme un ami un peu farceur."},
  {id:'matfr_lore_6', type:'map', zoneId:'matfr_ce2_4', emoji:'🥁', title:'Le tambour de pierre',
   text:"Au creux de la Vallée des Tambours dort une grosse pierre plate et ronde. Quand on tape doucement dessus, elle résonne comme un vrai tambour, un peu grave et un peu joyeux à la fois — toujours au même rythme, disent les habitants, que le cœur de la vallée elle-même."},
  {id:'matfr_lore_7', type:'zone', zoneId:'matfr_cm1_1', emoji:'🎣', title:'Le mot qui flotte',
   text:"Sur la Rive aux Rimes, on raconte qu'un tout petit mot flotte depuis toujours entre deux eaux, sans jamais couler ni s'envoler. Personne n'a réussi à l'attraper, mais tous ceux qui passent par là jurent l'avoir vu scintiller, juste un instant, avant de replonger doucement."},
  {id:'matfr_lore_8', type:'map', zoneId:'matfr_cm1_4', emoji:'🐬', title:'L\u2019écho qui rit',
   text:"Dans la Crique des Échos, il y a un endroit précis où chaque mot qu'on prononce revient un peu transformé en rire. Personne ne sait vraiment pourquoi, mais les habitants du coin adorent y venir juste pour se faire une bonne surprise, rien qu'en disant bonjour."},
  {id:'matfr_lore_9', type:'zone', zoneId:'matfr_cm2_1', emoji:'🕯️', title:'La bougie qui chuchote',
   text:"À l'Entrée Murmurante, une petite bougie brûle depuis toujours sans jamais s'éteindre ni fondre. Quand elle vacille doucement, on dirait presque qu'elle chuchote quelque chose à l'oreille de ceux qui passent tout près. Personne n'a encore réussi à comprendre ce qu'elle raconte."},
  {id:'matfr_lore_10', type:'map', zoneId:'matfr_cm2_4', emoji:'💧', title:'La goutte qui compte',
   text:"Dans le Couloir Bleu, une goutte d'eau tombe toujours au même endroit, toutes les nuits, depuis un temps immémorial. On raconte qu'elle compte patiemment chaque mot retrouvé dans le pays, une goutte à la fois, en attendant le tout dernier."},
  {id:'matfr_lore_11', type:'zone', zoneId:'matfr_final_2', emoji:'🔤', title:'La lettre égarée',
   text:"Tout en haut de la Tour de l'Alphabet, une petite lettre s'est un jour égarée loin de ses sœurs, et personne ne l'a jamais réclamée. Elle vit là depuis, un peu seule mais très fière, persuadée qu'un jour, un mot viendra enfin la chercher pour de bon."},
  {id:'matfr_lore_12', type:'map', zoneId:'matfr_final_4', emoji:'🪜', title:'La marche qui manque',
   text:"Sur l'Escalier des Mots, il manque justement une seule marche, tout en haut, comme si un mot important n'avait jamais fini d'être posé. Les habitants du château racontent que le jour où quelqu'un la retrouvera, l'escalier sera enfin complet, du tout premier au tout dernier mot."},
 ],
 // v12.6.0 : Odyssée 3/7. Ton primaire (un peu plus d'aventure que la
 // maternelle, toujours bienveillant), monde fantastique classique.
 prim: [
  {id:'prim_lore_1', type:'zone', zoneId:'plaine', emoji:'🐦', title:'Le nid du dernier moineau chanteur',
   text:"Quelque part dans la Plaine des Débuts se cache le nid d'un moineau qui, dit-on, connaît la toute première chanson jamais inventée dans la région. Les voyageurs racontent qu'on peut parfois l'entendre au lever du jour, mais que personne n'a jamais réussi à la retenir en entier avant qu'elle ne s'envole avec le vent."},
  {id:'prim_lore_2', type:'map', zoneId:'bonbons', emoji:'🍬', title:'Le bonbon qui ne fond jamais',
   text:"Perdu quelque part dans le Pays des Bonbons, un unique bonbon doré résiste à tout : à la pluie, au soleil, et même aux dents les plus gourmandes. La légende raconte qu'il a été offert par le tout premier confiseur du royaume, et qu'il attend celui qui saura enfin le mériter."},
  {id:'prim_lore_3', type:'zone', zoneId:'foret', emoji:'🦉', title:'L\u2019arbre aux mille anneaux',
   text:"Au cœur de la Forêt Enchantée pousse un arbre si vieux que personne n'a jamais réussi à compter tous ses anneaux. Les hiboux du coin racontent qu'à chaque anneau correspond une histoire différente, et que l'arbre les murmure doucement à qui sait vraiment prendre le temps d'écouter."},
  {id:'prim_lore_4', type:'map', zoneId:'plage', emoji:'🐚', title:'Le coquillage qui garde les marées',
   text:"Sur la Plage Ensoleillée, un coquillage minuscule et un peu bosselé garde en mémoire, dit-on, la trace de toutes les marées passées par ici. Les pêcheurs du coin le consultent parfois avant une grande sortie en mer, persuadés qu'il porte chance à qui le traite avec respect."},
  {id:'prim_lore_5', type:'zone', zoneId:'desert', emoji:'🏺', title:'La jarre sans fond',
   text:"Enfouie sous le sable du Désert de Feu se trouve une vieille jarre en terre cuite dont personne n'a jamais atteint le fond. Les caravaniers racontent qu'elle est toujours à moitié pleine d'une eau étonnamment fraîche, comme si le désert refusait de la laisser se vider complètement."},
  {id:'prim_lore_6', type:'map', zoneId:'profondeurs', emoji:'🫧', title:'La bulle qui remonte depuis toujours',
   text:"Quelque part dans les Profondeurs Océanes s'élève sans arrêt une unique bulle d'air, toujours la même, depuis un temps que personne ne sait mesurer. Les poissons du coin l'accompagnent parfois jusqu'à la surface, avant qu'une nouvelle ne reprenne aussitôt son chemin."},
  {id:'prim_lore_7', type:'zone', zoneId:'glace', emoji:'❄️', title:'Le flocon qui ne fond jamais',
   text:"Au sommet des Pics de Glace repose un unique flocon de neige, resté parfaitement intact malgré toutes les saisons qui passent. Les habitants racontent qu'il est tombé le tout premier jour où la montagne a existé, et qu'il continuera de briller là-haut bien après que tout le reste aura fondu."},
  {id:'prim_lore_8', type:'map', zoneId:'espace', emoji:'🌠', title:'L\u2019étoile qui ne file jamais tout à fait',
   text:"Quelque part dans la Galaxie Infinie brille une étoile un peu particulière, qui commence sans cesse à filer... avant de se raviser à mi-chemin et de reprendre bien sagement sa place. Certains disent qu'elle hésite depuis toujours entre rester et partir."},
  {id:'prim_lore_9', type:'zone', zoneId:'sanctuaire', emoji:'🕯️', title:'La flamme du tout premier vœu',
   text:"Au plus profond du Sanctuaire Final brûle une petite flamme, plus ancienne que tout le reste du royaume. On raconte qu'elle fut allumée par le tout premier vœu jamais formulé ici, et qu'elle ne s'éteindra que le jour où plus personne n'osera rêver."},
 ],
 // v12.6.0 : Odyssée 4/7. Verbopolis — lore centré sur les mots/la langue
 // eux-mêmes, en écho direct au thème de cette Odyssée.
 primfr: [
  {id:'primfr_lore_1', type:'zone', zoneId:'primfr_plaine', emoji:'🏘️', title:'Le mot qui a construit sa propre maison',
   text:"Dans les Faubourgs de Verbopolis se dresse une drôle de petite maison, entièrement bâtie avec des lettres de bois assemblées les unes aux autres. On raconte qu'un mot oublié de tous l'a construite lui-même, pierre par pierre, dans l'espoir qu'un jour, quelqu'un viendrait enfin le prononcer à voix haute."},
  {id:'primfr_lore_2', type:'map', zoneId:'primfr_bonbons', emoji:'🍬', title:'La syllabe qui a le goût du miel',
   text:"Au Marché aux Syllabes, une syllabe minuscule et dorée se vend, dit-on, plus cher que toutes les autres : elle aurait littéralement le goût du miel quand on la prononce. Personne n'a jamais réussi à en trouver une seconde, ce qui la rend encore plus précieuse aux yeux des marchands du coin."},
  {id:'primfr_lore_3', type:'zone', zoneId:'primfr_foret', emoji:'📚', title:'L\u2019étagère qui ne se remplit jamais tout à fait',
   text:"Tout au fond de la Rue des Libraires se cache une étagère très particulière, toujours presque pleine sans jamais l'être vraiment. Chaque fois qu'un livre nouveau y trouve sa place, une place vide réapparaît aussitôt ailleurs, comme si la rue refusait qu'on cesse un jour d'y lire."},
  {id:'primfr_lore_4', type:'map', zoneId:'primfr_plage', emoji:'📖', title:'Le livre qui flotte',
   text:"Sur les Quais de la Lecture, un vieux livre relié de cuir flotte paisiblement depuis des années, sans jamais couler ni s'abîmer. Les marins racontent qu'il attend un lecteur assez curieux pour venir le repêcher, mais que ses pages restent parfaitement sèches, quoi qu'il arrive."},
  {id:'primfr_lore_5', type:'zone', zoneId:'primfr_desert', emoji:'🏺', title:'Le mot rare enfermé dans une jarre',
   text:"Dans les Halles aux Mots repose une vieille jarre scellée, dont on raconte qu'elle enferme le tout dernier exemplaire d'un mot devenu si rare que plus personne ne l'utilise. Les marchands se le transmettent avec grand soin, persuadés qu'un mot, même oublié, mérite toujours d'être protégé."},
  {id:'primfr_lore_6', type:'map', zoneId:'primfr_profondeurs', emoji:'🔦', title:'L\u2019écho qui cherche un sens',
   text:"Tout au fond des Souterrains du Sens résonne un écho un peu particulier, qui répète sans cesse la même syllabe, comme s'il cherchait le mot entier auquel elle appartient. Certains explorateurs affirment qu'un jour, quelqu'un finira par la compléter pour de bon."},
  {id:'primfr_lore_7', type:'zone', zoneId:'primfr_glace', emoji:'⏰', title:'L\u2019horloge gelée sur la bonne heure',
   text:"Dans le Quartier des Horloges, une seule horloge est restée figée par le gel, depuis si longtemps que personne ne se souvient de son installation. Curieusement, elle indique toujours l'heure exacte, comme si le temps lui-même avait décidé de s'arrêter juste pour elle."},
  {id:'primfr_lore_8', type:'map', zoneId:'primfr_espace', emoji:'🌃', title:'La virgule qui flotte entre les toits',
   text:"Au-dessus des Toits de la Syntaxe flotte, dit-on, une toute petite virgule égarée, qui n'a jamais retrouvé la phrase à laquelle elle appartenait. Les habitants du quartier prétendent qu'elle redescend parfois, le soir, se glisser dans une conversation qui en avait justement besoin."},
  {id:'primfr_lore_9', type:'zone', zoneId:'primfr_sanctuaire', emoji:'📜', title:'Le tout premier mot jamais écrit',
   text:"Au plus profond de l'Antre du Docteur Babel serait conservé le tout premier mot jamais écrit dans l'histoire de Verbopolis. Personne ne sait lequel c'est vraiment, mais tous s'accordent à dire que sans lui, aucun des autres n'aurait jamais pu exister."},
 ],
 // v12.6.0 : Odyssée 5/7. Périodes historiques réelles (Préhistoire → Égypte
 // → Rome → Moyen Âge → Temps modernes) — occasion de lore VÉRIDIQUE, en plus
 // d'être curieux, en cohérence avec la vocation éducative de cette Odyssée.
 primhist: [
  {id:'primhist_lore_1', type:'zone', zoneId:'primhist_plaine', emoji:'🔥', title:'Le feu qui n\u2019a jamais dû s\u2019éteindre',
   text:"Dans la Clairière du Foyer, une légende raconte qu'un feu très ancien n'a jamais été laissé s'éteindre, transporté avec grand soin de génération en génération. Allumer un feu était si difficile à l'époque que le préserver, jour après jour, comptait parmi les tâches les plus précieuses de toute la tribu."},
  {id:'primhist_lore_2', type:'map', zoneId:'primhist_bonbons', emoji:'🎨', title:'La peinture faite avec de la terre',
   text:"Au fond de la Grotte aux Peintures, une empreinte de main ocre est restée gravée sur la roche depuis des milliers d'années. Les premiers artistes fabriquaient leurs couleurs eux-mêmes, en broyant simplement de la terre, du charbon et des pierres colorées trouvées aux alentours."},
  {id:'primhist_lore_3', type:'zone', zoneId:'primhist_foret', emoji:'🐊', title:'Le fleuve qui montait chaque année',
   text:"Le long des Rives du Nil, les habitants de l'Égypte ancienne attendaient chaque année la crue du fleuve. En débordant doucement sur ses rives, le Nil déposait une terre noire et fertile, sans laquelle les récoltes du pays n'auraient jamais pu pousser."},
  {id:'primhist_lore_4', type:'map', zoneId:'primhist_plage', emoji:'⚓', title:'Le port qui a vu passer les pierres géantes',
   text:"Depuis le Port de Thèbes, d'immenses blocs de pierre voyageaient autrefois sur le Nil, transportés sur de longues barges, pour aller bâtir temples et tombeaux dans tout le royaume. Certains de ces blocs pesaient plus lourd que plusieurs éléphants réunis."},
  {id:'primhist_lore_5', type:'zone', zoneId:'primhist_desert', emoji:'🛣️', title:'La route qui traverse encore le temps',
   text:"La Voie Appienne fut l'une des toutes premières grandes routes pavées de l'Empire romain, si solidement construite que des tronçons entiers existent encore aujourd'hui. Les Romains l'appelaient fièrement la « Reine des routes »."},
  {id:'primhist_lore_6', type:'map', zoneId:'primhist_profondeurs', emoji:'💧', title:'Les bains qui pouvaient accueillir une foule entière',
   text:"Les Thermes de Caracalla n'étaient pas de simples bains : c'était un immense lieu de vie, où des milliers de Romains venaient chaque jour se laver, discuter, faire du sport et même lire. L'eau y était chauffée par d'immenses fourneaux, cachés sous les sols."},
  {id:'primhist_lore_7', type:'zone', zoneId:'primhist_glace', emoji:'❄️', title:'Le rempart qui a résisté à tous les hivers',
   text:"Les Remparts d'Hiver de ce château médiéval ont été bâtis avec des pierres si épaisses qu'ils protégeaient aussi bien du froid glacial que des attaques ennemies. Les gardes se relayaient sans jamais laisser un seul créneau sans surveillance, même par les nuits les plus rudes."},
  {id:'primhist_lore_8', type:'map', zoneId:'primhist_espace', emoji:'🎈', title:'Le ciel qui a vu voler les premiers engins',
   text:"Le Ciel de 1889 a vu se croiser les tout premiers ballons dirigeables et les débuts de l'aviation naissante, à une époque où voler relevait encore presque du miracle. Beaucoup n'y croyaient pas, jusqu'au jour où ils ont vu, de leurs propres yeux, un engin s'élever dans les airs."},
  {id:'primhist_lore_9', type:'zone', zoneId:'primhist_sanctuaire', emoji:'⏳', title:'L\u2019établi qui a vu naître mille inventions',
   text:"Dans l'Atelier d'Autrefois repose un vieil établi de bois, usé par des générations d'inventeurs qui s'y sont succédé. Chaque nouvelle marque et chaque nouvelle éraflure sur son plateau correspond, dit-on, à une invention différente, née ici au fil du temps."},
 ],
 // v12.6.0 : Odyssée 6/7. Ton collège (vocabulaire plus riche, un soupçon de
 // mystère/gravité, jamais anxiogène), univers fantastique du donjon.
 col: [
  {id:'col_lore_1', type:'zone', zoneId:'col_cp_1', emoji:'⚓', title:'L\u2019ancre qui refuse de rouiller',
   text:"Au fond du Port des Décimales repose une vieille ancre de fer, plongée dans l'eau salée depuis des décennies sans jamais rouiller. Les marins du coin racontent qu'elle appartenait au tout premier navire à avoir cartographié ces côtes, et qu'elle continue, à sa façon, de veiller sur le port."},
  {id:'col_lore_2', type:'map', zoneId:'col_cp_4', emoji:'🪸', title:'Le récif qui change de forme',
   text:"Le Récif Trompeur mérite bien son nom : sa silhouette semble changer légèrement d'une marée à l'autre, au point que même les pêcheurs les plus expérimentés s'y perdent parfois. Certains pensent qu'un courant particulier y sculpte lentement le corail, année après année."},
  {id:'col_lore_3', type:'zone', zoneId:'col_ce1_1', emoji:'🕸️', title:'La toile tissée en spirale parfaite',
   text:"Au plus profond des Cavernes Fractionnaires, une araignée légendaire aurait tissé une toile d'une régularité si parfaite que chaque section semble être une copie exacte, en plus petit, de la précédente. Personne n'a réussi à en trouver le centre exact, ni même à en compter tous les fils."},
  {id:'col_lore_4', type:'map', zoneId:'col_ce1_4', emoji:'🦇', title:'L\u2019écho qui répète en cascade',
   text:"Dans la Grotte aux Échos, un simple cri se répète en cascade, chaque écho un peu plus faible que le précédent, jusqu'à s'évanouir presque totalement dans le silence. Les habitants du coin s'amusent parfois à compter combien de fois leur voix leur revient."},
  {id:'col_lore_5', type:'zone', zoneId:'col_ce2_1', emoji:'🌡️', title:'Le thermomètre qui n\u2019a jamais atteint le zéro',
   text:"Sur le Plateau des Relatifs trône un vieux thermomètre de bois, planté là depuis des générations. On raconte qu'il n'a jamais, de toute son histoire, affiché exactement zéro degré, oscillant sans cesse entre un peu plus chaud et un peu plus froid, comme s'il refusait de se figer sur un seul nombre."},
  {id:'col_lore_6', type:'map', zoneId:'col_ce2_4', emoji:'🧊', title:'Le glacier qui garde une trace de chaque hiver',
   text:"Le Glacier Gradué doit son nom aux fines lignes qui strient sa surface, une pour chaque hiver passé depuis des siècles. Les explorateurs racontent qu'en comptant patiemment ces lignes, on peut retracer l'histoire complète du climat de toute la région."},
  {id:'col_lore_7', type:'zone', zoneId:'col_cm1_1', emoji:'🏰', title:'La statue qui tient une lettre inconnue',
   text:"Au centre de la Citadelle Algébrique se dresse une statue ancienne, tenant dans sa main de pierre un symbole que personne n'a jamais su identifier avec certitude. Certains chercheurs pensent qu'il s'agit d'une toute première tentative d'écrire un nombre... avant même que les nombres n'aient de vrai nom."},
  {id:'col_lore_8', type:'map', zoneId:'col_cm1_4', emoji:'📚', title:'L\u2019ouvrage relié dans une langue oubliée',
   text:"Cachée au fond de la Bibliothèque Secrète, une unique étagère renferme un vieux traité relié dans une langue que plus personne ne sait lire. Les érudits de la citadelle se relaient depuis des années pour tenter de le déchiffrer, convaincus qu'il cache une découverte oubliée depuis bien trop longtemps."},
  {id:'col_lore_9', type:'zone', zoneId:'col_cm2_1', emoji:'📐', title:'Le triangle gravé dans la roche brûlante',
   text:"Au fond des Gorges de Pythagore, un triangle parfait a été gravé à même la roche, si profondément qu'il a résisté à des siècles d'éruptions et de vents brûlants. Personne ne sait qui l'a tracé le premier, mais tous ceux qui le découvrent racontent avoir ressenti un curieux frisson de fierté ancienne."},
  {id:'col_lore_10', type:'map', zoneId:'col_cm2_4', emoji:'🌋', title:'La caldeira qui chante avant chaque éruption',
   text:"La Caldeira Brûlante émettrait, dit-on, un très léger chant grave juste avant chaque éruption, comme un avertissement patient adressé à qui sait l'écouter. Les habitants les plus prudents de la région affirment ne jamais s'aventurer trop près sans avoir d'abord tendu l'oreille un long moment."},
  {id:'col_lore_11', type:'zone', zoneId:'col_final_1', emoji:'🔭', title:'La lunette braquée sur une étoile invisible',
   text:"Dans l'Observatoire des Fonctions, une vieille lunette reste en permanence pointée vers un unique point du ciel, où pourtant aucune étoile visible ne semble briller. Les astronomes qui se sont succédé ici jurent tous avoir, un jour ou l'autre, aperçu une lueur fugace exactement à cet endroit."},
  {id:'col_lore_12', type:'map', zoneId:'col_final_4', emoji:'🌀', title:'La spirale gravée qui ne se referme jamais',
   text:"La Spirale du Calcul est gravée à même le sol de pierre, s'enroulant sans fin vers un centre qu'on n'atteint, dit-on, jamais tout à fait en la suivant du regard. Certains visiteurs racontent avoir eu la sensation étrange de tourner en rond, alors même qu'ils avançaient bel et bien vers le cœur du dessin."},
  {id:'col_lore_13', type:'zone', zoneId:'col_titan_2', emoji:'✨', title:'La galerie où brillent d\u2019anciennes lumières',
   text:"La Galerie des Étoiles Mortes tire son nom des lueurs pâles qui continuent d'y scintiller, bien après que leurs sources d'origine se sont éteintes depuis longtemps. Les rares visiteurs qui s'y aventurent racontent ressentir un curieux mélange de mélancolie et d'émerveillement face à cette lumière qui refuse de disparaître tout à fait."},
 ],
 // v12.6.0 : Odyssée 7/7. Bibliothèque infinie / Monotonia — lore littéraire,
 // parfois teinté de la mélancolie propre à cette dystopie, mais toujours
 // refermé sur une note de curiosité ou d'espoir, jamais anxiogène.
 colfr: [
  {id:'colfr_lore_1', type:'zone', zoneId:'colfr_col_cp_1', emoji:'🌊', title:'Le mot qui a traversé le fleuve à la nage',
   text:"On raconte que dans le Fleuve des Langues flotte, depuis des siècles, un unique mot ancien qui aurait refusé de se laisser emporter par le courant de l'oubli. Les linguistes les plus patients affirment qu'on peut encore l'apercevoir, certains soirs calmes, remonter lentement à contre-courant."},
  {id:'colfr_lore_2', type:'map', zoneId:'colfr_col_cp_4', emoji:'🖋️', title:'La plume qui écrit encore toute seule',
   text:"Dans le Cloître des Moines repose une vieille plume d'oie, oubliée sur un pupitre depuis des générations. Les rares visiteurs jurent qu'elle bouge parfois légèrement toute seule, comme si elle continuait, patiemment, de copier un manuscrit que personne d'autre ne peut voir."},
  {id:'colfr_lore_3', type:'zone', zoneId:'colfr_col_ce1_1', emoji:'🔮', title:'Le reflet qui ne dit jamais le même mot',
   text:"Dans la Caverne aux Mille Reflets, chaque miroir semble répéter un mot différent quand on s'en approche, sans qu'aucun ne se répète jamais deux fois. Certains explorateurs affirment avoir passé des heures entières à en faire le tour, sans jamais réussir à tous les entendre."},
  {id:'colfr_lore_4', type:'map', zoneId:'colfr_col_ce1_4', emoji:'🖼️', title:'Le tableau qui change de registre',
   text:"Un tableau accroché dans la Galerie des Registres semble représenter une scène différente selon la distance à laquelle on l'observe : de loin, une fête populaire ; de près, un discours solennel. Les conservateurs eux-mêmes ne s'accordent toujours pas sur ce qu'il représente vraiment."},
  {id:'colfr_lore_5', type:'zone', zoneId:'colfr_col_ce2_1', emoji:'🎙️', title:'Le pupitre qui garde tous les discours',
   text:"Au centre de l'Agora se dresse un vieux pupitre de pierre, où l'on raconte que résonnent encore, très faiblement, tous les discours jamais prononcés ici. Certains soirs de grand silence, les habitants du quartier affirment percevoir un murmure de voix mêlées, trop ancien pour qu'on en distingue un seul mot."},
  {id:'colfr_lore_6', type:'map', zoneId:'colfr_col_ce2_4', emoji:'📢', title:'Le porte-voix qui n\u2019appartient à personne',
   text:"Abandonné sur une estrade du Forum du Débat, un vieux porte-voix en cuivre semble attendre, depuis toujours, qu'un nouvel orateur vienne enfin s'en emparer. Personne ne sait à qui il appartenait à l'origine, mais tous s'accordent à dire qu'il porte étonnamment bien la voix, même après tant d'années."},
  {id:'colfr_lore_7', type:'zone', zoneId:'colfr_col_cm1_1', emoji:'⚙️', title:'L\u2019horloge qui compte les phrases, pas les heures',
   text:"Au cœur de la Cité-Horlogerie, une horloge très particulière n'égrène pas les heures mais, dit-on, le nombre de phrases prononcées dans la cité depuis sa construction. Personne ne l'a jamais vue s'arrêter, pas même une seconde, ce qui laisse penser que la ville n'a jamais cessé de parler."},
  {id:'colfr_lore_8', type:'map', zoneId:'colfr_col_cm1_4', emoji:'🌉', title:'Le pont qui relie deux idées',
   text:"Le Pont des Subordonnées porte bien son nom : on raconte qu'il ne peut être traversé que par ceux qui savent relier clairement une idée à une autre. Les ingénieurs de la cité affirment qu'aucune pierre de ce pont n'a jamais eu besoin d'être réparée, comme s'il refusait tout simplement de s'effondrer."},
  {id:'colfr_lore_9', type:'zone', zoneId:'colfr_col_cm2_1', emoji:'🎭', title:'Le masque qui change d\u2019expression',
   text:"Accroché en évidence au Théâtre-Monde, un vieux masque de bois semble changer très légèrement d'expression selon la lumière du jour. Les comédiens qui s'y produisent racontent qu'ils préfèrent toujours répéter en sa présence, convaincus qu'il porte chance à qui sait le respecter."},
  {id:'colfr_lore_10', type:'map', zoneId:'colfr_col_cm2_4', emoji:'🪞', title:'Le miroir qui ne renvoie jamais le même reflet',
   text:"Dans le Cabinet des Miroirs, un unique miroir ancien ne semble jamais renvoyer exactement le même reflet à deux visiteurs différents. Certains y voient un visage plus jeune, d'autres plus âgé, et personne n'a jamais réussi à expliquer pourquoi, ni même à s'accorder sur ce qu'il montre vraiment."},
  {id:'colfr_lore_11', type:'zone', zoneId:'colfr_col_final_1', emoji:'🌫️', title:'L\u2019affiche à moitié effacée',
   text:"Sur un mur des Faubourgs Gris subsiste une vieille affiche, si effacée par le temps qu'on ne distingue plus que quelques lettres éparses. Certains habitants affirment pourtant qu'en la regardant assez longtemps, les mots manquants finissent presque par se deviner tout seuls."},
  {id:'colfr_lore_12', type:'map', zoneId:'colfr_col_final_4', emoji:'📯', title:'Le clairon resté silencieux',
   text:"Posé en évidence sur l'estrade de la Grande Tribune, un vieux clairon de cuivre n'a plus sonné depuis des années, pour une raison que personne ne connaît vraiment. Certains racontent qu'il attend simplement le bon moment pour retentir de nouveau, et que ce moment n'est peut-être plus si loin."},
  {id:'colfr_lore_13', type:'zone', zoneId:'colfr_col_titan_2', emoji:'📕', title:'L\u2019étagère où dorment les mots interdits',
   text:"Dans la Galerie des Mots Morts s'alignent d'innombrables reliures poussiéreuses, chacune renfermant, dit-on, un mot tombé injustement dans l'oubli. Les rares visiteurs qui s'y aventurent racontent avoir l'impression très nette que ces mots, loin d'être morts pour de bon, attendent patiemment qu'on les prononce à nouveau."},
 ],
};
