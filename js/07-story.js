...
const _COL_STORY_FR = {
 ...
 chapters: {
  ...
  cm2:   { id:'colfr_c_cm2', title:'Livre V — Le Miroir des Genres', crystal:"le pouvoir d'Imaginaire", pages:[
   ...
   { emoji:'🚪', text:"Dans le silence qui suit, un martèlement de bottes retentit à l'entrée du théâtre. Tu te fonds derrière un rideau de velours mité, le cœur battant : une escouade de Censeurs, menée par un officier que tu ne reconnais pas, inspecte la salle « suite à une rumeur de lumière suspecte ». Ils repartent bredouilles, mais tu comprends que Monotonia, désormais, te cherche activement." },
  ]},
 ...
 victories: {
  ...
  ce1: { id:'colfr_w_ce1', title:'Pouvoir gagné : la Nuance', crystal:'la Nuance', pages:[
   ...
   { emoji:'😂', text:"Aurèle, qui a lu les deux galets par-dessus ton épaule sans la moindre gêne, hausse un sourcil savant : « Un mot doux et un mot d'alarme, dans cet ordre précis... Voilà bien la preuve, jeune Porteur, que même au cœur du danger, certains trouvent le temps de soigner leur ponctuation sentimentale. »" },
  ]},
  ce2: { id:'colfr_w_ce2', title:"Pouvoir gagné : l'Éloquence", crystal:"l'Éloquence", pages:[
   ...
   { emoji:'🕊️', text:"Avant de repartir, Solène glisse dans ta main un petit ruban tressé, tricoté dans le secret des Murmureurs : « Pour la Grande Tribune, le jour venu, murmure-t-elle. J'ai idée que toi aussi, tu auras besoin d'un peu de courage emprunté, ce jour-là. »" },
  ]},
...
function _colBook1Pages(){
 ...
 return [
  ...
  { chap:'XIV — Les mots qui s\'éteignent', html:"<p>Une langue ne fait pas que naître : elle oublie aussi. Des mots autrefois courants, comme <i>ouïr</i> (entendre) ou <i>icelui</i> (celui-ci), ont peu à peu déserté la conversation quotidienne pour ne survivre que dans quelques expressions figées — « ouï-dire », par exemple, garde la trace d'un verbe presque éteint partout ailleurs.</p>" },
  { chap:'XIV — Les mots qui s\'éteignent', html:"<p>Ce n'est pas une perte totale : les dictionnaires et les vieux textes gardent la mémoire de ces mots, prêts à ressurgir si un écrivain ou un poète décide un jour de leur redonner vie. Une langue vivante perd des mots comme un arbre perd des feuilles — et en fait pousser d'autres, aussitôt, à leur place.</p>" },
  { chap:'XV — Clôture', illus:I_KEY, cap:'Premier pouvoir reconquis.', html:"<p>Te voici au bout du premier livre. Ta langue est l'héritage de Gaulois et de Romains, de Grecs savants et de Francs guerriers, de rois et de poètes, d'Arabes savants et de marchands italiens, et désormais de millions de locuteurs à travers le monde — un trésor que mille générations t'ont transmis. {villain} voudrait te faire croire que les mots ne servent qu'à obéir. Mais tu sais, désormais, qu'ils portent toute l'histoire des hommes.</p>" },
 ];
}
...
function _colBook2Pages(){
 ...
 return [
  ...
  { chap:'XIII — Écrire selon l\'écran', html:"<p>Un nouveau registre est né avec les écrans : celui des messages rapides, où l'on abrège pour aller vite — « bcp » pour beaucoup, « auj » pour aujourd'hui. Ce n'est pas un français fautif : c'est un code de vitesse, réservé à la conversation entre amis, qui ne remplace jamais l'orthographe complète d'une lettre officielle ou d'une dissertation.</p>" },
  { chap:'XIII — Écrire selon l\'écran', html:"<p>Savoir naviguer entre ces deux mondes — l'abréviation entre amis, la phrase soignée pour le reste — c'est encore une application du même principe que tout ce livre t'a enseigné : connaître son registre, et choisir le bon au bon moment.</p>" },
  { chap:'XIV — Clôture', illus:PRISME, cap:'Deuxième pouvoir reconquis.', html:"<p>Te voici au bout du deuxième tome. Tu sais désormais qu'un mot n'est jamais seul : il a une famille, des cousins plus précis et des contraires bien nets, un registre — jusque sur un écran —, un double sens, mille façons de briller, le pouvoir de s'en inventer de nouveaux, des couleurs régionales, de sages détours, et des images toutes faites pleines de saveur. {villain} voudrait n'en garder qu'un par idée. Mais celui qui possède la <b>Nuance</b> possède le doute, la précision, et le droit de n'être pas tout à fait d'accord.</p>" },
 ];
}
...
function _colBook3Pages(){
 ...
 return [
  ...
  { chap:'XIV — Gagner l\'oreille, avant les mots', html:"<p>Les orateurs antiques avaient un nom pour le tout premier instant d'un discours, avant même le premier argument : la <b>captatio benevolentiae</b>, littéralement « la capture de la bienveillance ». Une plaisanterie légère, un compliment sincère à l'auditoire, un aveu d'humilité — tout est bon pour endormir la méfiance et se faire écouter avant de convaincre.</p>" },
  { chap:'XIV — Gagner l\'oreille, avant les mots', html:"<p>Cette entrée en matière ne remplace jamais l'argument qui suit : elle ne fait qu'ouvrir la porte. Un discours qui ne serait que captatio, sans rien derrière, retomberait aussi vite qu'un feu de paille — c'est la solidité du raisonnement, ensuite, qui fait qu'on s'en souvient.</p>" },
  { chap:'XV — Clôture', illus:FLAME, cap:'Troisième pouvoir reconquis.', html:"<p>Te voici au bout du troisième tome. Tu sais défendre une thèse, équilibrer l'ethos, le pathos et le logos, débattre loyalement, démasquer les sophismes et la manipulation, manier les outils de la persuasion, à l'oral comme à l'écrit, faire rire honnêtement, convaincre par le récit, lire ce que le corps ne dit pas en mots, et gagner une oreille avant même de parler. L'<b>Éloquence</b> est tienne. Mais souviens-toi du serment des vrais orateurs : cette flamme éclaire, elle ne brûle pas. Mets-la au service de la vérité — jamais du tyran.</p>" },
 ];
}
...
function _colBook4Pages(){
 ...
 return [
  ...
  { chap:'XV — L\'infinitif, le mode sans visage', html:"<p>Un mode verbal se distingue de tous les autres par son étrange neutralité : l'<b>infinitif</b>. « Parler », « choisir », « vivre » ne disent ni qui, ni quand — c'est la forme du verbe la plus nue, celle qu'on trouve dans le dictionnaire, avant qu'elle ne se conjugue et prenne un visage précis.</p>" },
  { chap:'XV — L\'infinitif, le mode sans visage', html:"<p>C'est aussi le mode des grandes formules universelles, des maximes qui s'adressent à tous sans distinction de personne : « Vivre libre ou mourir », lit-on sur certains frontons. Aucun sujet précis, et pourtant, cette phrase concerne tout le monde à la fois — la preuve qu'une forme grammaticale peut, lorsqu'elle est choisie avec justesse, porter une force presque universelle.</p>" },
  { chap:'XVI — Clôture', illus:GEAR, cap:'Quatrième pouvoir reconquis.', html:"<p>Te voici au bout du quatrième tome. Tu sais bâtir une phrase d'aplomb, choisir le mode et le temps justes, accorder les temps, emboîter les subordonnées, ponctuer, lier les idées, les reprendre par le bon pronom, accepter les belles exceptions, préciser sans alourdir, et reconnaître la force nue de l'infinitif — et tu sais désormais que la langue vit aussi dans la rue, se recense dans de grands livres patients, voyage depuis l'imprimerie, et peut chanter sur mille rythmes différents. La <b>Précision</b> est tienne. Souviens-toi : une phrase juste est une arme que nul ne peut retourner contre toi — et c'est précisément ce que {villain} ne sait pas tordre.</p>" },
 ];
}
...
function _colBook5Pages(){
 ...
 return [
  ...
  { chap:'XIV — Le conte qui s\'enchaîne', html:"<p>Certains contes très anciens obéissent à une structure particulière, dite <b>en randonnée</b> ou <b>en accumulation</b> : un personnage rencontre quelqu'un, puis un autre, puis un autre encore, chacun s'ajoutant à la file sans que les précédents ne disparaissent — jusqu'à une chute finale qui fait basculer toute la chaîne d'un coup.</p>" },
  { chap:'XIV — Le conte qui s\'enchaîne', html:"<p>Ce schéma tout simple, transmis à l'oral depuis des générations bien avant d'être couché sur le papier, plaît particulièrement aux plus jeunes lecteurs : il rassure par sa répétition, tout en gardant en réserve la surprise du dénouement. Une preuve de plus qu'une structure, même très ancienne, n'a pas fini de faire ses preuves.</p>" },
  { chap:'XV — Clôture', illus:MASK, cap:'Cinquième pouvoir reconquis.', html:"<p>Te voici au bout du cinquième et dernier livre-monde. Tu connais le conte et son merveilleux — jusque dans ses structures les plus anciennes —, la poésie et son chant, le théâtre et ses masques, le roman et son regard, l'écrit qui combat, les genres toujours en invention, les œuvres qui voyagent, celles qu'on fredonne, celles qui se dessinent, ceux qui les célèbrent, celles qui font rire en faisant réfléchir, et l'art d'ouvrir et de refermer un livre. L'<b>Imaginaire</b> est tien. Cinq pouvoirs reconquis ! Il ne te reste qu'à rentrer à Monotonia — car ces mots, désormais, tu vas devoir les rendre à tout un peuple. Le <b>Réveil</b> approche.</p>" },
 ];
}
