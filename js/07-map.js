...
function _setSubjectLogos(){
 try{
  ...
  let src, alt, lbl;
  if(subj==='fr'){ src='assets/logo-mots.webp?v=1064'; alt="L'Odyssée des Mots"; lbl="L'ODYSSÉE : L'AVENTURE LITTÉRAIRE"; }
  else if(subj==='math'){ src='assets/logo-main.webp?v=1064'; alt="L'Odyssée des Chiffres"; lbl="L'ODYSSÉE : L'AVENTURE MATHÉMATIQUE"; }
  else { src='assets/logo-savoir.webp?v=1064'; alt="L'Odyssée du Savoir"; lbl="L'ODYSSÉE DU SAVOIR"; }
