...
{id:'kp11',name:"Huntrix",uni:"K-pop Demon Hunters",uk:'kp',em:'🎤',em2:'✨',color:'#e84393',gc:'#a55eea',desc:"Le trio d'idoles chasseuses réuni au grand complet. Ensemble, leurs voix tissent un bouclier de lumière qui repousse les démons les plus puissants.",r:'épique',p:230},
{id:'kp12',name:"Saja Boys",uni:"K-pop Demon Hunters",uk:'kp',em:'🎸',em2:'🔥',color:'#2c3e50',gc:'#8e44ad',desc:"Le boys band venu des ténèbres au complet. Charismatiques et dangereux, ils envoûtent les foules pour mieux servir leur cause obscure.",r:'épique',p:230},
