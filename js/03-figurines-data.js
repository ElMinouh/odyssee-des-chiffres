...
{id:'nj09',name:'Garmadon Quatre Bras',uni:'Ninjago',uk:'nj',em:'👹',em2:'💥',color:'#4a0080',gc:'#9b59b6',desc:'La forme ultime de Lord Garmadon, dotée de quatre bras maniant les quatre armes des Ninja d\'Or simultanément. Résultat du venin corrupteur de tous les grands serpents de Ninjago. Tenue violette et rouge, yeux rouges brillants : la manifestation physique du mal absolu dans Ninjago.',r:'exclusif',p:500,completionLock:true,unlockHint:'🏆 Achetable en réunissant les 12 autres figurines Ninjago'},
...
{id:'gd10',name:'Goldorak',uni:'Goldorak',uk:'gd',em:'🤖',em2:'⚡',color:'#2c3e50',gc:'#74b9ff',desc:"Le robot géant ! Goldorak est piloté par Actarus. Ses deux cornes en V, son visor orange et sa gemme rouge frontale sont ses marques iconiques. GOLDRAAAKE !",r:'exclusif',p:500,completionLock:true,unlockHint:'🏆 Achetable en réunissant les 9 autres figurines Goldorak'},
{id:'gd11',name:'Goldorak & Soucoupe',uni:'Goldorak',uk:'gd',em:'🤖',em2:'🛸',color:'#1a2a3a',gc:'#74b9ff',desc:"Goldorak combiné avec son vaisseau soucoupe Grendizer ! Cette combinaison représente la puissance ultime contre Véga.",r:'exclusif',p:500,completionLock:true,unlockHint:'🏆 Achetable en réunissant les 9 autres figurines Goldorak'},
...
{id:'co08',name:'Cobra Rugball',uni:'Cobra',uk:'co',em:'🏉',em2:'💥',color:'#e67e22',gc:'#f0a050',desc:'Cobra sous l\'identité de Joe Gillian, champion du Rugball — sport spatial le plus violent de la galaxie. Sous ce déguisement sportif, le pirate dissimule son Psychogun et son passé légendaire, prouvant qu\'il excelle dans tous les domaines.',r:'exclusif',p:500,completionLock:true,unlockHint:'🏆 Achetable en réunissant les 7 autres figurines Cobra'},
...
{id:'tl18',name:'Le cœur de Balaïna',uni:'Tobie Lolness',uk:'tl',em:'💠',em2:'✨',color:'#00acc1',gc:'#4dd0e1',
 ...
 r:'exclusif',p:500,completionLock:true,
 unlockHint:'🏆 Achetable en réunissant les 17 autres figurines Tobie Lolness'}
];
