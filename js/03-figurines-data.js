...
const FIG_IMG_PRELOAD = [
  ...
  'sw15', 'sw16', 'sw17', 'sw18', 'sw19', 'sw20', 'sw21',
  'sw22', 'sw23',
  // Reine des Neiges (7)
  ...
  'mc08', 'mc09', 'mc10', 'mc11', 'mc12', 'mc13', 'mc14',
  'mc15',
  // Goldorak (11)
...
{id:'db36',name:'Frieza Doré',uni:'Dragon Ball',uk:'db',em:'👑',em2:'✨',color:'#f1c40f',gc:'#fdc830',desc:'Forme ultime de Freezer obtenue après 4 mois d\'entraînement intensif en enfer. Son corps doré scintillant et ses pupilles violettes témoignent d\'une puissance multipliée. Plus rapide et plus puissant que sa forme finale précédente, il rivalise même avec Goku Super Saiyan Blue. Sa vanité divine en fait un antagoniste éternellement fascinant.',r:'exclusif',p:0,completionLock:true,unlockHint:'🏆 Débloqué en réunissant les 34 autres figurines Dragon Ball'},
{id:'db37',name:'Les Boules de Cristal',uni:'Dragon Ball',uk:'db',em:'⭐',em2:'🐉',color:'#f39c12',gc:'#f7dc6f',desc:'Sept sphères orange ornées d\'un nombre d\'étoiles rouges différent, dispersées aux quatre coins du monde par le Dieu Dragon Shenron lui-même. Réunies toutes les sept, elles invoquent le dragon sacré et exaucent n\'importe quel vœu. Créées par le Namek Kami, elles sont au cœur de chaque grande aventure de Son Goku et ses amis, des origines jusqu\'aux confrontations les plus épiques.',r:'exclusif',p:0,completionLock:true,unlockHint:'🏆 Débloqué en réunissant les 34 autres figurines Dragon Ball'},
{id:'db38',name:'Le Dragon Radar',uni:'Dragon Ball',uk:'db',em:'📡',em2:'🔴',color:'#e74c3c',gc:'#ff6b6b',desc:'Invention géniale de Bulma capable de détecter l\'emplacement précis de chaque Boule de Cristal, où qu\'elle se trouve sur Terre. Son écran circulaire affiche un point lumineux par boule repérée, guidant les héros dans leur quête à travers déserts, océans et volcans. Sans cet appareil, jamais Son Goku n\'aurait pu rassembler les sept sphères légendaires.',r:'exclusif',p:0,completionLock:true,unlockHint:'🏆 Débloqué en réunissant les 34 autres figurines Dragon Ball'},
{id:'db39',name:'Le Nuage Magique',uni:'Dragon Ball',uk:'db',em:'☁️',em2:'💛',color:'#f7dc6f',gc:'#fff3b0',desc:'Nuage doré et duveteux offert par Maître Karin, que seul un cœur pur peut chevaucher — quiconque nourrit de mauvaises pensées en tombe aussitôt. Fidèle compagnon de Son Goku depuis l\'enfance, il file à une vitesse fulgurante à travers le ciel. Un simple sifflement suffit à l\'appeler, où que se trouve son maître.',r:'exclusif',p:0,completionLock:true,unlockHint:'🏆 Débloqué en réunissant les 34 autres figurines Dragon Ball'},
{id:'db40',name:'Le Bâton Magique',uni:'Dragon Ball',uk:'db',em:'🎋',em2:'✨',color:'#e67e22',gc:'#f0a500',desc:'Hérité de son grand-père Son Gohan, ce bâton extensible peut s\'allonger à volonté jusqu\'à toucher la Lune. Arme de prédilection de Son Goku enfant, il lui permet de franchir des gouffres, d\'assommer ses adversaires ou de se hisser au sommet des montagnes les plus escarpées. Rangé plus tard au profit du combat à mains nues, il reste un symbole des débuts aventureux du héros.',r:'exclusif',p:0,completionLock:true,unlockHint:'🏆 Débloqué en réunissant les 34 autres figurines Dragon Ball'},
{id:'db41',name:'Les Potalas',uni:'Dragon Ball',uk:'db',em:'💠',em2:'🟠',color:'#8e44ad',gc:'#bb8fce',desc:'Boucles d\'oreilles sacrées des Kaïo-Shin, capables de fusionner deux êtres en un seul guerrier d\'une puissance décuplée — une fusion permanente, contrairement à la Danse Fusion. C\'est ainsi que Végéta et Son Goku deviennent Vegetto, le guerrier ultime capable de rivaliser avec Buu lui-même. Un artefact divin réservé aux plus grands périls.',r:'exclusif',p:0,completionLock:true,unlockHint:'🏆 Débloqué en réunissant les 34 autres figurines Dragon Ball'},
{id:'db42',name:'Les Haricots Magiques',uni:'Dragon Ball',uk:'db',em:'🫘',em2:'💚',color:'#27ae60',gc:'#69f0ae',desc:'Cultivés par Maître Karin au sommet de sa tour, ces petits haricots verts restaurent instantanément toute l\'énergie et guérissent la moindre blessure, même les plus graves. Un seul suffit à rassasier un guerrier pour dix jours entiers. Indispensables lors des combats les plus longs, ils sauvent la vie de Son Goku et ses compagnons à d\'innombrables reprises.',r:'exclusif',p:0,completionLock:true,unlockHint:'🏆 Débloqué en réunissant les 34 autres figurines Dragon Ball'},
{id:'db43',name:'Le Vaisseau spatial de Freezer',uni:'Dragon Ball',uk:'db',em:'🛸',em2:'💜',color:'#6c3483',gc:'#a569bd',desc:'Vaisseau ovoïde ultramoderne à bord duquel Freezer parcourt la galaxie pour conquérir des planètes. Équipé de capsules de soin régénérantes et d\'une technologie largement supérieure à tout ce que la Terre connaît, il incarne la puissance écrasante de l\'Empire de Freezer. C\'est à son bord que le tyran s\'enfuit de Namek après sa défaite face à Son Goku Super Saiyan.',r:'exclusif',p:0,completionLock:true,unlockHint:'🏆 Débloqué en réunissant les 34 autres figurines Dragon Ball'},
{id:'db44',name:'La Machine à voyager dans le temps de Trunks',uni:'Dragon Ball',uk:'db',em:'⏱️',em2:'🔷',color:'#2980b9',gc:'#5dade2',desc:'Capsule de voyage temporel construite par Bulma dans un futur ravagé par les Androïdes, permettant à Trunks de remonter le temps pour avertir les héros du danger à venir. Bleue et compacte, elle se replie en une simple capsule de transport. Son unique aller-retour scelle le destin de plusieurs lignes temporelles distinctes.',r:'exclusif',p:0,completionLock:true,unlockHint:'🏆 Débloqué en réunissant les 34 autres figurines Dragon Ball'},
{id:'db45',name:'Les Capsules',uni:'Dragon Ball',uk:'db',em:'💊',em2:'🏠',color:'#16a085',gc:'#48c9b0',desc:'Invention emblématique de la Capsule Corporation permettant de miniaturiser maisons, véhicules et objets entiers dans de minuscules capsules de la taille d\'une pilule. Il suffit de les jeter au sol pour qu\'ils reprennent instantanément leur taille réelle. Bulma et sa famille les utilisent au quotidien, un symbole du génie technologique qui accompagne les héros dans chacun de leurs voyages.',r:'exclusif',p:0,completionLock:true,unlockHint:'🏆 Débloqué en réunissant les 34 autres figurines Dragon Ball'},
...
{id:'sw18',name:'L\'Étoile de la Mort',uni:'Star Wars',uk:'sw',em:'🌑',em2:'💥',color:'#5d6d7e',gc:'#aeb6bf',desc:'Station de combat de la taille d\'une petite lune, arme ultime de l\'Empire Galactique capable de pulvériser une planète entière d\'un seul tir de son super-laser — le sort tragique d\'Alderaan en témoigne. Malgré sa puissance titanesque, un unique point faible thermique, atteint par le tir précis de Luke Skywalker guidé par la Force, suffira à la détruire au-dessus de Yavin.',r:'exclusif',p:0,completionLock:true,unlockHint:'🏆 Débloqué en réunissant les 17 autres figurines Star Wars'},
{id:'sw19',name:'Destroyer stellaire de classe impériale',uni:'Star Wars',uk:'sw',em:'🔺',em2:'⚙️',color:'#34495e',gc:'#7f8c8d',desc:'Vaisseau capital triangulaire de plus de 1600 mètres de long, colonne vertébrale de la flotte impériale et symbole même de l\'oppression galactique. Chaque Destroyer transporte des milliers de chasseurs TIE, de troupes et de véhicules, capable à lui seul de soumettre un système entier. Sa silhouette menaçante fendant l\'espace annonce toujours l\'arrivée de l\'Empire.',r:'exclusif',p:0,completionLock:true,unlockHint:'🏆 Débloqué en réunissant les 17 autres figurines Star Wars'},
{id:'sw20',name:'Chasseur TIE',uni:'Star Wars',uk:'sw',em:'🔻',em2:'⚡',color:'#2c3e50',gc:'#5d6d7e',desc:'Chasseur impérial reconnaissable entre tous à ses ailes hexagonales plates et à son sifflement suraigu si caractéristique. Rapide et bon marché, produit en série par milliers, il ne dispose ni de boucliers ni d\'hyperpropulseur — un choix assumé par l\'Empire qui préfère submerger l\'ennemi par le nombre plutôt que d\'équiper chaque pilote.',r:'exclusif',p:0,completionLock:true,unlockHint:'🏆 Débloqué en réunissant les 17 autres figurines Star Wars'},
{id:'sw21',name:'X-Wing T-65',uni:'Star Wars',uk:'sw',em:'✖️',em2:'🚀',color:'#e67e22',gc:'#f0932b',desc:'Chasseur emblématique de l\'Alliance Rebelle, dont les quatre ailes en S s\'ouvrent en position de combat pour révéler ses canons laser. Piloté par Luke Skywalker avec l\'aide de son droïde R2-D2 logé à l\'arrière, c\'est à son bord que le jeune héros, guidé par la voix de la Force, tire le coup fatal qui détruit l\'Étoile de la Mort.',r:'exclusif',p:0,completionLock:true,unlockHint:'🏆 Débloqué en réunissant les 17 autres figurines Star Wars'},
{id:'sw22',name:'TIE avancé de Dark Vador',uni:'Star Wars',uk:'sw',em:'⬛',em2:'🔴',color:'#1c1c1c',gc:'#c0392b',desc:'Version personnalisée et bien plus redoutable du chasseur TIE standard, réservée à Dark Vador lui-même. Équipé de boucliers déflecteurs et d\'un hyperpropulseur — des avantages refusés aux pilotes ordinaires — ce vaisseau aux ailes recourbées symbolise le statut unique du Seigneur Sith au sein de la flotte impériale, capable de traquer les Rebelles jusque dans les tranchées de l\'Étoile de la Mort.',r:'exclusif',p:0,completionLock:true,unlockHint:'🏆 Débloqué en réunissant les 17 autres figurines Star Wars'},
{id:'sw23',name:'Faucon Millenium',uni:'Star Wars',uk:'sw',em:'🛸',em2:'⭐',color:'#95a5a6',gc:'#d5dbdb',desc:'Vaisseau de contrebande de Han Solo et Chewbacca, réputé pour avoir bouclé la Course de Kessel en moins de douze parsecs. Sous son allure disgracieuse et rafistolée se cache l\'un des vaisseaux les plus rapides de la galaxie, modifié de mille façons par son capitaine. C\'est à son bord que Luke, Leïa et leurs amis échappent maintes fois à l\'Empire.',r:'exclusif',p:0,completionLock:true,unlockHint:'🏆 Débloqué en réunissant les 17 autres figurines Star Wars'},
...
{id:'nj09',name:'Garmadon Quatre Bras',uni:'Ninjago',uk:'nj',em:'👹',em2:'💥',color:'#4a0080',gc:'#9b59b6',desc:'La forme ultime de Lord Garmadon, dotée de quatre bras maniant les quatre armes des Ninja d\'Or simultanément. Résultat du venin corrupteur de tous les grands serpents de Ninjago. Tenue violette et rouge, yeux rouges brillants : la manifestation physique du mal absolu dans Ninjago.',r:'exclusif',p:0,completionLock:true,unlockHint:'🏆 Débloqué en réunissant les 12 autres figurines Ninjago'},
...
{id:'gd10',name:'Goldorak',uni:'Goldorak',uk:'gd',em:'🤖',em2:'⚡',color:'#2c3e50',gc:'#74b9ff',desc:"Le robot géant ! Goldorak est piloté par Actarus. Ses deux cornes en V, son visor orange et sa gemme rouge frontale sont ses marques iconiques. GOLDRAAAKE !",r:'exclusif',p:0,completionLock:true,unlockHint:'🏆 Débloqué en réunissant les 9 autres figurines Goldorak'},
{id:'gd11',name:'Goldorak & Soucoupe',uni:'Goldorak',uk:'gd',em:'🤖',em2:'🛸',color:'#1a2a3a',gc:'#74b9ff',desc:"Goldorak combiné avec son vaisseau soucoupe Grendizer ! Cette combinaison représente la puissance ultime contre Véga.",r:'exclusif',p:0,completionLock:true,unlockHint:'🏆 Débloqué en réunissant les 9 autres figurines Goldorak'},
...
{id:'mc12',name:'Le Grand Condor',uni:'Cités d\'Or',uk:'mc',em:'🦅',em2:'✨',color:'#d4a017',gc:'#f7dc6f',desc:'Majestueux oiseau mécanique doré, chef-d\'œuvre technologique conçu par Mendoza à partir de plans antiques. À son bord, Esteban, Zia et Tao survolent l\'Amérique du Sud tout entière à la recherche des Sept Cités d\'Or, échappant sans cesse aux pièges tendus par Gomez et Gaspard. Véritable symbole de la série, il incarne la liberté et l\'aventure.',r:'exclusif',p:0,completionLock:true,unlockHint:'🏆 Débloqué en réunissant les 11 autres figurines Cités d\'Or'},
{id:'mc13',name:'Solaris',uni:'Cités d\'Or',uk:'mc',em:'☀️',em2:'🏛️',color:'#f39c12',gc:'#fdc830',desc:'Cité mécanique flottante alimentée par l\'énergie solaire, l\'une des légendaires Sept Cités d\'Or bâties par la civilisation disparue de Mu. Capable de s\'élever dans les airs grâce à des miroirs géants concentrant la lumière du soleil, elle recèle des secrets technologiques qui dépassent l\'entendement de l\'époque des conquistadors.',r:'exclusif',p:0,completionLock:true,unlockHint:'🏆 Débloqué en réunissant les 11 autres figurines Cités d\'Or'},
{id:'mc14',name:'La machine volante des Olmèques',uni:'Cités d\'Or',uk:'mc',em:'🛩️',em2:'🗿',color:'#795548',gc:'#a1887f',desc:'Étonnant appareil volant hérité de l\'ancienne civilisation olmèque, mêlant mécanique ingénieuse et savoir ancestral oublié. Sa découverte prouve que les civilisations précolombiennes maîtrisaient des technologies avancées bien avant l\'arrivée des Espagnols, un des nombreux mystères archéologiques que croisent Esteban et ses compagnons.',r:'exclusif',p:0,completionLock:true,unlockHint:'🏆 Débloqué en réunissant les 11 autres figurines Cités d\'Or'},
{id:'mc15',name:'La Nef d\'Ambrosius',uni:'Cités d\'Or',uk:'mc',em:'🚢',em2:'⚙️',color:'#5d4037',gc:'#8d6e63',desc:'Impressionnant vaisseau mécanique du grand-prêtre Ambrosius, gardien ultime des secrets de Mu et de ses technologies perdues. À son bord, l\'énigmatique souverain dissimule ses véritables intentions jusqu\'aux révélations finales de la quête. Ce navire d\'un autre temps symbolise toute la grandeur déchue de la civilisation disparue.',r:'exclusif',p:0,completionLock:true,unlockHint:'🏆 Débloqué en réunissant les 11 autres figurines Cités d\'Or'},
...
{id:'tn09',name:'La Fusée',uni:'Tintin',uk:'tn',em:'🚀',em2:'🌕',color:'#c0392b',gc:'#ecf0f1',desc:'Fusée à damier rouge et blanc conçue par le professeur Tournesol, premier engin fictif à emmener l\'homme sur la Lune — publiée en bande dessinée près de vingt ans avant le véritable alunissage d\'Apollo 11 ! Tintin, Haddock et Tournesol y affrontent l\'apesanteur, le passager clandestin Tournesol... et le saboteur Jorgen infiltré à bord.',r:'exclusif',p:0,completionLock:true,unlockHint:'🏆 Débloqué en réunissant les 8 autres figurines Tintin'},
{id:'tn10',name:'Le Sous-marin requin',uni:'Tintin',uk:'tn',em:'🦈',em2:'⚓',color:'#1a5276',gc:'#5dade2',desc:'Étonnant sous-marin en forme de requin conçu par le professeur Tournesol pour explorer les fonds marins à la recherche de l\'épave du Licorne. Sa mâchoire ouverte et ses yeux globuleux trompent requins et poulpes tandis que Tintin et le capitaine Haddock plongent vers le trésor du chevalier de Hadoque, échappant de justesse à leurs rivaux.',r:'exclusif',p:0,completionLock:true,unlockHint:'🏆 Débloqué en réunissant les 8 autres figurines Tintin'},
...
{id:'ax10',name:'La Potion Magique',uni:'Astérix',uk:'ax',em:'🧪',em2:'🌿',color:'#27ae60',gc:'#82e0aa',desc:'Breuvage secret concocté par le druide Panoramix dans son chaudron doré, donnant à qui le boit une force surhumaine pendant un temps limité. Sa recette exacte demeure un mystère absolu — gui coupé à la serpe d\'or et ingrédients tenus secrets — connue du seul druide. C\'est elle qui permet aux irréductibles Gaulois de résister sans relâche à l\'envahisseur romain, village après village, aventure après aventure.',r:'exclusif',p:0,completionLock:true,unlockHint:'🏆 Débloqué en réunissant les 9 autres figurines Astérix'},
// ── MI / PJ / OT / CO / AL},
...
{id:'co08',name:'Cobra Rugball',uni:'Cobra',uk:'co',em:'🏉',em2:'💥',color:'#e67e22',gc:'#f0a050',desc:'Cobra sous l\'identité de Joe Gillian, champion du Rugball — sport spatial le plus violent de la galaxie. Sous ce déguisement sportif, le pirate dissimule son Psychogun et son passé légendaire, prouvant qu\'il excelle dans tous les domaines.',r:'exclusif',p:0,completionLock:true,unlockHint:'🏆 Débloqué en réunissant les 7 autres figurines Cobra'},
...
{id:'kp01',name:"Rumi",uni:"K-pop Demon Hunters",uk:'kp',em:'🎤',em2:'🗡️',color:'#8e44ad',gc:'#a55eea',desc:"Leader charismatique du trio d'idoles chasseuses de démons. Sa voix puissante fait trembler les ténèbres autant que les foules. Derrière les paillettes, elle porte un lourd secret et une détermination inébranlable.",r:'légendaire',p:350},
{id:'kp02',name:"Zoey",uni:"K-pop Demon Hunters",uk:'kp',em:'🎤',em2:'💥',color:'#e84393',gc:'#ff79c6',desc:"Membre pétillante du groupe, elle mêle énergie explosive et répliques cinglantes. Rappeuse redoutable sur scène comme au combat, elle transforme chaque concert en champ de bataille étincelant.",r:'épique',p:230},
{id:'kp03',name:"Mira",uni:"K-pop Demon Hunters",uk:'kp',em:'🎤',em2:'🌀',color:'#3498db',gc:'#5dade2',desc:"Danseuse gracieuse et guerrière implacable, elle enchaîne chorégraphies et coups précis. Son calme apparent cache une force qui met les démons en déroute.",r:'épique',p:230},
{id:'kp04',name:"Jinu",uni:"K-pop Demon Hunters",uk:'kp',em:'🎸',em2:'🖤',color:'#2c3e50',gc:'#576574',desc:"Leader ténébreux et magnétique du boys band venu de l'ombre. Charmeur irrésistible, il manipule les foules d'un simple regard. Rival fascinant, tiraillé entre séduction et rédemption.",r:'légendaire',p:350},
{id:'kp05',name:"Romance",uni:"K-pop Demon Hunters",uk:'kp',em:'🎸',em2:'💜',color:'#9b59b6',gc:'#bb8fce',desc:"Membre au charme envoûtant du boys band, il fait chavirer les cœurs à chaque note. Sous son sourire parfait se cache une aura mystérieuse.",r:'rare',p:150},
{id:'kp06',name:"Abby",uni:"K-pop Demon Hunters",uk:'kp',em:'🎸',em2:'💪',color:'#16a085',gc:'#1abc9c',desc:"Force tranquille du groupe, imposant et fiable. Sa présence rassurante contraste avec l'énergie survoltée de la scène.",r:'rare',p:150},
{id:'kp07',name:"Mystery",uni:"K-pop Demon Hunters",uk:'kp',em:'🎭',em2:'❓',color:'#34495e',gc:'#7f8c8d',desc:"Membre énigmatique et masqué dont personne ne connaît le vrai visage. Chacune de ses apparitions attise la curiosité des fans.",r:'rare',p:150},
{id:'kp08',name:"Baby",uni:"K-pop Demon Hunters",uk:'kp',em:'🍼',em2:'⭐',color:'#f1c40f',gc:'#f7dc6f',desc:"Le plus jeune du groupe, adorable et espiègle. Sa bouille attendrissante fait fondre le public, mais gare à ne pas le sous-estimer.",r:'peu commun',p:90},
{id:'kp09',name:"Derpy",uni:"K-pop Demon Hunters",uk:'kp',em:'😜',em2:'🎈',color:'#e67e22',gc:'#f0932b',desc:"Le rigolo maladroit de la bande, toujours un peu à côté de la chorégraphie. Ses gaffes attachantes en font le chouchou des fans.",r:'peu commun',p:90},
{id:'kp10',name:"Sussie",uni:"K-pop Demon Hunters",uk:'kp',em:'🐯',em2:'🌙',color:'#8e44ad',gc:'#c39bd3',desc:"Espiègle et imprévisible, elle apparaît quand on l'attend le moins. Un grain de folie qui pimente chaque scène.",r:'peu commun',p:90},
{id:'kp11',name:"Huntrix",uni:"K-pop Demon Hunters",uk:'kp',em:'🎤',em2:'✨',color:'#e84393',gc:'#a55eea',desc:"Le trio d'idoles chasseuses réuni au grand complet. Ensemble, leurs voix tissent un bouclier de lumière qui repousse les démons les plus puissants.",r:'exclusif',p:0,completionLock:true,unlockHint:'🏆 Débloqué en réunissant les 10 autres figurines K-pop Demon Hunters'},
{id:'kp12',name:"Saja Boys",uni:"K-pop Demon Hunters",uk:'kp',em:'🎸',em2:'🔥',color:'#2c3e50',gc:'#8e44ad',desc:"Le boys band venu des ténèbres au complet. Charismatiques et dangereux, ils envoûtent les foules pour mieux servir leur cause obscure.",r:'exclusif',p:0,completionLock:true,unlockHint:'🏆 Débloqué en réunissant les 10 autres figurines K-pop Demon Hunters'},
{id:'cy01',name:"Tadej Pogačar",uni:"Tour de France",uk:'cy',em:'🏆',em2:'🇸🇮',color:'#f1c40f',gc:'#f7dc6f',desc:"Phénomène slovène et multiple vainqueur du Tour de France. Grimpeur, rouleur et puncheur à la fois, il attaque de partout avec un sourire désarmant. L'un des plus grands talents de sa génération.",r:'légendaire',p:350},
{id:'cy02',name:"Jonas Vingegaard",uni:"Tour de France",uk:'cy',em:'⛰️',em2:'🇩🇰',color:'#e74c3c',gc:'#ff7675',desc:"Grimpeur danois d'exception et vainqueur du Tour de France. Discret mais redoutable en montagne, il transforme les cols en terrain de duel au sommet.",r:'légendaire',p:350},
{id:'cy03',name:"Paul Seixas",uni:"Tour de France",uk:'cy',em:'🚴',em2:'🇫🇷',color:'#3498db',gc:'#74b9ff',desc:"Jeune espoir français au talent précoce. Polyvalent et ambitieux, il incarne l'avenir du cyclisme tricolore.",r:'peu commun',p:90},
{id:'cy04',name:"Mathieu van der Poel",uni:"Tour de France",uk:'cy',em:'🌈',em2:'🇳🇱',color:'#f39c12',gc:'#ffb300',desc:"Coureur néerlandais explosif, roi des classiques et du cyclo-cross. Petit-fils de Raymond Poulidor, il porte un nom de légende avec panache.",r:'épique',p:230},
{id:'cy05',name:"Remco Evenepoel",uni:"Tour de France",uk:'cy',em:'⚡',em2:'🇧🇪',color:'#e74c3c',gc:'#ff6b6b',desc:"Prodige belge du contre-la-montre et des courses par étapes. Champion précoce, il roule comme une fusée contre le chrono.",r:'épique',p:230},
{id:'cy06',name:"Julian Alaphilippe",uni:"Tour de France",uk:'cy',em:'💥',em2:'🇫🇷',color:'#2980b9',gc:'#54a0ff',desc:"Puncheur français flamboyant, double champion du monde. Ses attaques rageuses en font l'un des coureurs les plus spectaculaires du peloton.",r:'épique',p:230},
{id:'cy07',name:"Thibaut Pinot",uni:"Tour de France",uk:'cy',em:'⛰️',em2:'🇫🇷',color:'#27ae60',gc:'#55efc4',desc:"Grimpeur français au grand cœur, idole des foules. Ses envolées en montagne ont fait vibrer des millions de supporters.",r:'rare',p:150},
{id:'cy08',name:"Paul Magnier",uni:"Tour de France",uk:'cy',em:'⚡',em2:'🇫🇷',color:'#e84393',gc:'#fd79a8',desc:"Jeune sprinteur français plein de promesses. Rapide et audacieux, il vise déjà les plus grandes lignes d'arrivée.",r:'peu commun',p:90},
{id:'cy09',name:"Wout van Aert",uni:"Tour de France",uk:'cy',em:'🚴',em2:'🇧🇪',color:'#f1c40f',gc:'#ffeaa7',desc:"Coureur belge ultra-polyvalent : sprint, montagne, chrono, classiques. Un couteau suisse capable de tout gagner.",r:'rare',p:150},
{id:'cy10',name:"Romain Grégoire",uni:"Tour de France",uk:'cy',em:'🚴',em2:'🇫🇷',color:'#3498db',gc:'#74b9ff',desc:"Jeune coureur français prometteur, régulier et combatif. Un espoir sur lequel la France compte pour l'avenir.",r:'peu commun',p:90},
{id:'cy11',name:"Kévin Vauquelin",uni:"Tour de France",uk:'cy',em:'🚴',em2:'🇫🇷',color:'#16a085',gc:'#55efc4',desc:"Jeune Français offensif, à l'aise dans les échappées comme sur les terrains vallonnés. Une valeur montante du peloton.",r:'peu commun',p:90},
{id:'cy12',name:"Lenny Martinez",uni:"Tour de France",uk:'cy',em:'⛰️',em2:'🇫🇷',color:'#27ae60',gc:'#7bed9f',desc:"Jeune grimpeur français léger comme une plume. Issu d'une famille de cyclistes, il brille dès que la route s'élève.",r:'rare',p:150},
{id:'cy13',name:"Mads Pedersen",uni:"Tour de France",uk:'cy',em:'⚡',em2:'🇩🇰',color:'#c0392b',gc:'#ff7675',desc:"Coureur danois puissant, ancien champion du monde. Redoutable sur les classiques et au sprint après une course usante.",r:'rare',p:150},
{id:'cy14',name:"Isaac Del Toro",uni:"Tour de France",uk:'cy',em:'🚴',em2:'🇲🇽',color:'#e67e22',gc:'#fab1a0',desc:"Jeune talent mexicain au grand avenir. Combatif et ambitieux, il porte les espoirs du cyclisme d'Amérique latine.",r:'peu commun',p:90},
{id:'cy15',name:"Tim Merlier",uni:"Tour de France",uk:'cy',em:'⚡',em2:'🇧🇪',color:'#8e44ad',gc:'#c39bd3',desc:"Sprinteur belge explosif, spécialiste des arrivées massives. Une pointe de vitesse impressionnante dans les derniers mètres.",r:'peu commun',p:90},
{id:'cy16',name:"Christophe Laporte",uni:"Tour de France",uk:'cy',em:'🚴',em2:'🇫🇷',color:'#2980b9',gc:'#74b9ff',desc:"Coureur français complet et généreux, précieux équipier et vainqueur d'étapes. Rapide et loyal.",r:'peu commun',p:90},
{id:'cy17',name:"Benoît Cosnefroy",uni:"Tour de France",uk:'cy',em:'💥',em2:'🇫🇷',color:'#e74c3c',gc:'#ff7675',desc:"Puncheur français accrocheur, à l'aise sur les parcours vallonnés. Toujours prêt à saisir sa chance dans les bosses.",r:'peu commun',p:90},
{id:'cy18',name:"Primož Roglič",uni:"Tour de France",uk:'cy',em:'🏆',em2:'🇸🇮',color:'#f39c12',gc:'#ffb300',desc:"Grand coureur slovène de courses par étapes, ancien sauteur à ski. Régulier et coriace, il collectionne les grands tours.",r:'rare',p:150},
{id:'cy19',name:"Juan Ayuso",uni:"Tour de France",uk:'cy',em:'⛰️',em2:'🇪🇸',color:'#e67e22',gc:'#fab1a0',desc:"Jeune grimpeur espagnol très prometteur. Élégant et endurant, il vise les sommets des plus grandes courses.",r:'rare',p:150},
{id:'cy20',name:"Tom Pidcock",uni:"Tour de France",uk:'cy',em:'🚵',em2:'🇬🇧',color:'#9b59b6',gc:'#bb8fce',desc:"Coureur britannique surdoué et polyvalent : VTT, cyclo-cross et route. Champion olympique de VTT, il descend comme personne.",r:'rare',p:150},
{id:'cy21',name:"Mark Cavendish",uni:"Tour de France",uk:'cy',em:'⚡',em2:'🇬🇧',color:'#3498db',gc:'#54a0ff',desc:"Sprinteur britannique de légende, recordman de victoires d'étapes sur le Tour. Une fusée aux réflexes hors normes.",r:'épique',p:230},
{id:'cy22',name:"Alberto Contador",uni:"Tour de France",uk:'cy',em:'⛰️',em2:'🇪🇸',color:'#f1c40f',gc:'#f7dc6f',desc:"Grand champion espagnol, grimpeur explosif et multiple vainqueur de grands tours. Ses attaques 'pistolero' sont restées célèbres.",r:'épique',p:230},
{id:'cy23',name:"Philippe Gilbert",uni:"Tour de France",uk:'cy',em:'🌈',em2:'🇧🇪',color:'#e74c3c',gc:'#ff6b6b',desc:"Coureur belge des classiques, ancien champion du monde. Puncheur rusé, vainqueur des plus grandes courses d'un jour.",r:'rare',p:150},
{id:'cy24',name:"Peter Sagan",uni:"Tour de France",uk:'cy',em:'🌈',em2:'🇸🇰',color:'#27ae60',gc:'#55efc4',desc:"Showman slovaque, multiple champion du monde et roi du maillot vert. Sprinteur-puncheur spectaculaire au charisme unique.",r:'épique',p:230},
{id:'cy25',name:"Laurent Jalabert",uni:"Tour de France",uk:'cy',em:'🏆',em2:'🇫🇷',color:'#2980b9',gc:'#54a0ff',desc:"Grand champion français des années 1990, vainqueur de nombreuses courses. Coureur complet, longtemps numéro un mondial.",r:'rare',p:150},
{id:'cy26',name:"Miguel Indurain",uni:"Tour de France",uk:'cy',em:'🏆',em2:'🇪🇸',color:'#f39c12',gc:'#ffb300',desc:"Géant espagnol, vainqueur de cinq Tours de France consécutifs. Maître absolu du contre-la-montre, calme et impérial.",r:'légendaire',p:350},
{id:'cy27',name:"Laurent Fignon",uni:"Tour de France",uk:'cy',em:'⛰️',em2:'🇫🇷',color:'#27ae60',gc:'#7bed9f',desc:"Double vainqueur du Tour de France, célèbre pour ses lunettes rondes et son panache. Un champion français au caractère bien trempé.",r:'épique',p:230},
{id:'cy28',name:"Bernard Hinault",uni:"Tour de France",uk:'cy',em:'🏆',em2:'🇫🇷',color:'#e74c3c',gc:'#ff6b6b',desc:"'Le Blaireau', quintuple vainqueur du Tour et dernier Français à l'avoir gagné. Un champion au tempérament de feu.",r:'légendaire',p:350},
{id:'cy29',name:"Richard Virenque",uni:"Tour de France",uk:'cy',em:'⛰️',em2:'🇫🇷',color:'#8e44ad',gc:'#c39bd3',desc:"Grimpeur français très populaire, recordman du maillot à pois de meilleur grimpeur. Idole des cols pyrénéens et alpins.",r:'rare',p:150},
...
{id:'tl18',name:'Le cœur de Balaïna',uni:'Tobie Lolness',uk:'tl',em:'💠',em2:'✨',color:'#00acc1',gc:'#4dd0e1',
 ...
 r:'exclusif',p:0,completionLock:true,
...
Object.assign(FIG_PAGES, {
 ...
 ot04: [
  "Ben Becker est le meilleur ami d'Olivier et son partenaire offensif de toujours. Milieu créatif au tempérament calme, il excelle dans les passes décisives et la construction du jeu.",
  "Leur duo Olivier-Ben, d'une complicité rare, est l'un des plus emblématiques de la série. Discret mais décisif, il suit son père de ville en ville.",
 ],
 ot05: [
 ...
 ot06: [
  "Ed Warner est le gardien de l'équipe Toho et le rival amical de Thomas Price. Il s'inspire du karaté et des arts martiaux pour des arrêts spectaculaires.",
  "Souple et explosif, il bondit dans tous les coins de sa cage avec un cri de guerre impressionnant. Ed compte parmi les gardiens les plus marquants de la série.",
 ],
 ot07: [
...
Object.assign(FIG_PAGES, {
 ...
 mc07: [
  "Pichu est le perroquet apprivoisé de Tao, au plumage vert, jaune et rouge éclatant. Bavard et farceur, il imite les voix et veille sur la troupe du haut des airs.",
  "Fidèle compagnon, il suit Esteban, Zia et Tao tout au long du voyage et donne souvent l'alerte en cas de danger. Pichu apporte une touche de tendresse et d'humour à la grande aventure.",
 ],
 mc08: [
...
const _CONTENT_UPDATES = [
 ...
 {
  id: 'update_2026_09_exclusifs',
  title: '🎉 Nouveau dans ta collection !',
  items: [
   {emoji:'⭐', text:'6 nouvelles figurines exclusives <b>Star Wars</b> à débloquer en réunissant toute la collection !'},
   {emoji:'🦅', text:'4 nouvelles figurines exclusives <b>Les mystérieuses cités d\'or</b> !'},
