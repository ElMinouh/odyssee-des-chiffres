...
const PRIM_ZONES=[
 ...
 // ═══════════════════════════════════════════════════════
 {id:'plaine',  region:'cp',label:'Plaine des Débuts',bg:'linear-gradient(135deg,#27ae60,#2ecc71)',emoji:'🌾',boss:'🐺',bossName:'Loup des Plaines',level:'CP', starsReq:0,   theme:'standard',
 ...
 {id:'village',  region:'cp',label:'Village Joyeux',   bg:'linear-gradient(135deg,#f4a261,#e9c46a)',emoji:'🏡',boss:'🐔',bossName:'Coq Gigantesque',level:'CP', starsReq:25,  theme:'standard',
 ...
 {id:'prairie',  region:'cp',label:'Prairie Fleurie',  bg:'linear-gradient(135deg,#ffd166,#a8d8a8)',emoji:'🌻',boss:'🐝',bossName:'Reine des Abeilles',level:'CP', starsReq:40,  theme:'standard',
 ...
 {id:'bonbons',  region:'cp',label:'Pays des Bonbons', bg:'linear-gradient(135deg,#ff9ec7,#ffd6e8)',emoji:'🍭',boss:'🍩',bossName:'Donut Maléfique',level:'CP', starsReq:60,  theme:'sakura',
 ...
 // ═══════════════════════════════════════════════════════
 {id:'foret',  region:'ce1',label:'Forêt Enchantée',  bg:'linear-gradient(135deg,#1b6b3a,#2ecc71)',emoji:'🌲',boss:'🐲',bossName:'Dragon de Forêt', level:'CE1',starsReq:80,  theme:'foret',
 ...
 {id:'champignons',region:'ce1',label:'Vallée des Champignons',bg:'linear-gradient(135deg,#7a5c3a,#a0826d)',emoji:'🍄',boss:'🐌',bossName:'Escargot Géant',level:'CE1',starsReq:110, theme:'foret',
 ...
 {id:'trolls',  region:'ce1',label:'Forêt des Trolls', bg:'linear-gradient(135deg,#2d4a2d,#5a7a5a)',emoji:'⛺',boss:'👺',bossName:'Grand Troll',     level:'CE1',starsReq:145, theme:'foret',
 ...
 {id:'plage',  region:'ce1',label:'Plage Ensoleillée',bg:'linear-gradient(135deg,#fff5d6,#fcbf49)',emoji:'🏖️',boss:'🦀',bossName:'Crabe Royal',     level:'CE1',starsReq:185, theme:'ocean',
 ...
 // ═══════════════════════════════════════════════════════
 {id:'desert',  region:'ce2',label:'Désert de Feu',    bg:'linear-gradient(135deg,#e67e22,#c0392b)',emoji:'🏜️',boss:'🦂',bossName:'Scorpion Géant',  level:'CE2',starsReq:235, theme:'volcan',
 ...
 {id:'plaines_venteuses',region:'ce2',label:'Plaines Venteuses',bg:'linear-gradient(135deg,#c2a878,#8b7355)',emoji:'🌪️',boss:'🦬',bossName:'Bison Tonnerre',level:'CE2',starsReq:290, theme:'standard',
 ...
 {id:'temple',  region:'ce2',label:'Temple Antique',   bg:'linear-gradient(135deg,#8b6914,#d4af37)',emoji:'🏛️',boss:'🗿',bossName:'Gardien de Pierre',level:'CE2',starsReq:350, theme:'chateau',
 ...
 {id:'profondeurs',region:'ce2',label:'Profondeurs Océanes',bg:'linear-gradient(135deg,#011f3f,#013a63)',emoji:'🌊',boss:'🐙',bossName:'Kraken Abyssal',level:'CE2',starsReq:415, theme:'ocean',
 ...
 // ═══════════════════════════════════════════════════════
 {id:'glace',  region:'cm1',label:'Pics de Glace',    bg:'linear-gradient(135deg,#2980b9,#74b9ff)',emoji:'🏔️',boss:'❄️',bossName:'Géant de Glace',  level:'CM1',starsReq:490, theme:'banquise',
 ...
 {id:'marais',  region:'cm1',label:'Marais Lugubre',   bg:'linear-gradient(135deg,#4a5d3a,#2d3a1f)',emoji:'🕷️',boss:'🐍',bossName:'Hydre Marécageuse',level:'CM1',starsReq:575, theme:'foret',
 ...
 {id:'forteresse',region:'cm1',label:'Forteresse Médiévale',bg:'linear-gradient(135deg,#3a2e1f,#5c4530)',emoji:'🏰',boss:'🐉',bossName:'Dragon Cuirassé',level:'CM1',starsReq:670, theme:'chateau',
 ...
 {id:'sakura',  region:'cm1',label:'Mont Sakura',      bg:'linear-gradient(135deg,#ff8fb3,#e56b9b)',emoji:'🌸',boss:'🥷',bossName:'Maître Ninja',     level:'CM1',starsReq:775, theme:'sakura',
 ...
 {id:'nocturne',region:'cm1',label:'Royaume Nocturne', bg:'linear-gradient(135deg,#1b2735,#090a0f)',emoji:'🌙',boss:'🧛',bossName:'Seigneur des Ombres',level:'CM1',starsReq:890, theme:'nuit',
 ...
 // ═══════════════════════════════════════════════════════
 {id:'volcan',  region:'cm2',label:'Volcan Maudit',    bg:'linear-gradient(135deg,#8b0000,#e74c3c)',emoji:'🌋',boss:'🔥',bossName:'Seigneur des Flammes',level:'CM2',starsReq:1015,theme:'volcan',
 ...
 {id:'espace',  region:'cm2',label:'Galaxie Infinie',  bg:'linear-gradient(135deg,#1a1c2c,#9b59b6)',emoji:'🌌',boss:'👽',bossName:'Alien Quantique',  level:'CM2',starsReq:1150,theme:'espace',
 ...
 {id:'cimes',  region:'cm2',label:'Cimes Vertigineuses',bg:'linear-gradient(135deg,#4a6d8c,#a0b8d0)',emoji:'⛰️',boss:'🦅',bossName:'Roc Empereur',    level:'CM2',starsReq:1295,theme:'standard',
 ...
 {id:'mecanique',region:'cm2',label:'Cité Mécanique',  bg:'linear-gradient(135deg,#7a3a08,#c47a1f)',emoji:'⚙️',boss:'🤖',bossName:'Mecha Suprême',    level:'CM2',starsReq:1450,theme:'volcan',
 ...
 {id:'ile',  region:'cm2',label:'Île Mystérieuse',  bg:'linear-gradient(135deg,#1b4332,#2d6a4f)',emoji:'🏝️',boss:'🏴‍☠️',bossName:'Capitaine Fantôme',level:'CM2',starsReq:1525,theme:'ocean',
 ...
 // ═══════════════════════════════════════════════════════
 {id:'sanctuaire',region:'final',label:'Sanctuaire Final',bg:'linear-gradient(135deg,#0a0014,#3a0a4a)',emoji:'⛩️',boss:'🌌',bossName:'Empereur Cosmique',level:'CM2',starsReq:1600,theme:'nuit',
...
const _BOSS_LINES = {
 ...
 // v12.4.20 — Odyssée 6/7 : Maths Collège (33 zones, identités déjà cohérentes
 // — jeux de mots mathématiques bien pensés, aucun changement nécessaire).
 col_cp_1: "Une virgule mal placée, et c'est le naufrage assuré... montre-moi que tu sais où la mettre.",
 col_cp_2: "Je rôde entre les décimales... une seule erreur, et je fonds sur toi.",
 col_cp_3: "Mon phare n'éclaire plus que les naufrages... le tien sera-t-il différent ?",
 col_cp_4: "Dans ces bas-fonds, chaque calcul faux finit entre mes mâchoires.",
 col_cp_5: "Tranche une de mes têtes... les décimales, elles, repoussent toujours.",
 col_ce1_1: "Chaque part de mon royaume est calculée au millimètre... ose en réclamer une injuste.",
 col_ce1_2: "Je mène ma meute au rythme des numérateurs... suis le rythme, ou reste à la traîne.",
 col_ce1_3: "Ce sentier ne se partage pas équitablement... à moins que tu saches vraiment diviser.",
 col_ce1_4: "Dans cette grotte, chaque écho cache une fraction... entends-tu la bonne réponse ?",
 col_ce1_5: "Le cœur de cette forêt bat au rythme des fractions... et il ne ralentit jamais.",
 col_ce2_1: "Sur ce plateau, chaque nombre relatif peut te glacer... si tu te trompes de signe.",
 col_ce2_2: "Je me faufile dans chaque soustraction mal posée... et je ne pardonne pas les signes oubliés.",
 col_ce2_3: "Du haut de cette crête, je vois tous les signes... même ceux que tu voudrais cacher.",
 col_ce2_4: "Ce glacier gradué n'a jamais laissé passer une erreur de signe... et moi non plus.",
 col_ce2_5: "Au sommet de ce pic, le zéro n'est qu'une illusion... approche, si tu l'oses.",
 col_cm1_1: "Chaque inconnue de cette citadelle m'appartient... jusqu'à ce que tu la résolves.",
 col_cm1_2: "Je veille sur cette salle depuis toujours... aucune variable ne m'échappe.",
 col_cm1_3: "Je suis forgé à partir des identités les plus remarquables... rien ne me brise facilement.",
 col_cm1_4: "Mille équations résolues m'ont maintenu en vie... la tienne sera-t-elle la millième et unième ?",
 col_cm1_5: "Ce donjon ne cède qu'à ceux qui maîtrisent vraiment l'algèbre... es-tu de ceux-là ?",
 col_cm2_1: "Ces gorges portent le nom de Pythagore... et je veille sur chaque triangle qui les traverse.",
 col_cm2_2: "Sur cette crête, chaque carré compte... et mon dard ne rate jamais les erreurs.",
 col_cm2_3: "Ce pont ne tient que par ses racines... comme moi, il ne cède jamais facilement.",
 col_cm2_4: "Je suis bâti sur deux cathètes parfaites... trouve la troisième, si tu peux.",
 col_cm2_5: "Au cœur de ce volcan, chaque théorème brûle d'une vérité ancienne... la connais-tu vraiment ?",
 col_final_1: "Cet observatoire n'a qu'un but : suivre chaque courbe jusqu'à sa vérité.",
 col_final_2: "Je traverse cette nébuleuse en ligne droite... dévie un instant, et tu me perds à jamais.",
 col_final_3: "Chaque image a son antécédent... et je garde ce champ jusqu'à ce qu'on le retrouve.",
 col_final_4: "Je traverse le ciel une fois par équation résolue... verrai-je passer la tienne ?",
 col_final_5: "Ce sanctuaire stellaire n'obéit qu'aux fonctions les plus pures... prouve que tu en maîtrises une.",
 col_titan_1: "Ce seuil de cendres n'a jamais laissé passer un esprit distrait... et moi je ne dors jamais.",
 col_titan_2: "Ces étoiles sont mortes depuis longtemps... mais moi, je renais à chaque tentative.",
 col_titan_3: "Je suis Léthéas. Ce trône a vu s'effacer bien des mémoires... la tienne y résistera-t-elle ?",
 // v12.4.20 — Odyssée 7/7 : Français Collège (33 zones, nouvelles identités
 // littéraires — voir _COLFR_BOSS_OVERRIDES, 07-story.js).
 colfr_col_cp_1: "Ce fleuve charrie toutes les langues qui ont formé la nôtre... sauras-tu remonter jusqu'à la source ?",
 colfr_col_cp_2: "Rome est tombée, mais ses mots, eux, n'ont jamais cessé de résonner en toi.",
 colfr_col_cp_3: "Avant le latin, il y avait nos mots à nous... les entends-tu encore, dans ce bois ?",
 colfr_col_cp_4: "J'ai recopié mille manuscrits à la main... une seule erreur, et des siècles de sens disparaissent.",
 colfr_col_cp_5: "Tout le français jaillit d'ici... prouve que tu en comprends l'origine.",
 colfr_col_ce1_1: "Chaque mot que tu prononces ici se reflète mille fois... un seul reflet dit la vérité.",
 colfr_col_ce1_2: "Chaque mot de mon verger partage la même racine... sauras-tu retrouver sa famille ?",
 colfr_col_ce1_3: "J'ai un mot pour chaque nuance... le tien sera-t-il assez précis pour m'acheter le bon ?",
 colfr_col_ce1_4: "Un mot familier ici, un mot soutenu là-bas... choisis mal, et ma galerie te rejette.",
 colfr_col_ce1_5: "Un seul mot peut refléter mille sens... trouve celui que je cherche, exactement.",
 colfr_col_ce2_1: "Sur cette place, les mots sont des armes... les tiens sont-ils assez tranchants ?",
 colfr_col_ce2_2: "Je n'ai jamais perdu un débat sur cette tribune... convaincs-moi, si tu l'oses.",
 colfr_col_ce2_3: "Derrière ce masque, seuls les arguments comptent... les tiens tiendront-ils la scène ?",
 colfr_col_ce2_4: "Ce forum n'a jamais tranché en faveur d'un argument bancal... le tien le sera-t-il ?",
 colfr_col_ce2_5: "Cicéron lui-même a forgé son éloquence ici... sa flamme brûle encore, à travers moi.",
 colfr_col_cm1_1: "Chaque verbe de cette cité tourne comme un rouage parfait... un seul temps mal réglé, et tout s'arrête.",
 colfr_col_cm1_2: "Ces engrenages n'avancent que si chaque accord s'enclenche parfaitement.",
 colfr_col_cm1_3: "Je mesure chaque temps du français, du plus ancien au plus futur... quelle heure est-il, pour toi ?",
 colfr_col_cm1_4: "Ce pont ne tient que si chaque proposition subordonnée trouve sa place exacte.",
 colfr_col_cm1_5: "Je suis le cœur qui fait battre toute la mécanique du verbe... arrête-moi, si tu peux.",
 colfr_col_cm2_1: "Le monde entier est une scène... et j'en écris chaque réplique.",
 colfr_col_cm2_2: "Chaque masque cache un genre littéraire... devine lequel se cache derrière celui-ci.",
 colfr_col_cm2_3: "Mille voix parlent par ma bouche... laquelle est la vraie, à ton avis ?",
 colfr_col_cm2_4: "Dans ce cabinet, rien n'est jamais tout à fait ce qu'il semble être... même moi.",
 colfr_col_cm2_5: "Je change de forme à chaque genre littéraire... sauras-tu me reconnaître, quelle que soit ma forme ?",
 colfr_col_final_1: "Ici, tout est gris, tout se ressemble... c'est exactement comme ça que Monotonia nous veut.",
 colfr_col_final_2: "Chut. Ici, on ne parle plus. On ne pense même plus tout haut.",
 colfr_col_final_3: "Je vois chaque mot que tu écris, chaque phrase que tu oses penser.",
 colfr_col_final_4: "Ici, une seule voix a le droit de s'exprimer... et ce n'est pas la tienne. Pas encore.",
 colfr_col_final_5: "Je suis le dernier rempart avant l'aube... aucun mot libre ne passera par moi.",
 colfr_col_titan_1: "Ce palais est tombé en cendres depuis longtemps... mais sa garde, elle, veille toujours.",
 colfr_col_titan_2: "Chaque mot interdit finit ici, entre mes mains... pour toujours, si je le décide.",
 colfr_col_titan_3: "Je suis le Chancelier. Tous les mots de ce monde m'appartiennent... jusqu'à ce que quelqu'un ose me le disputer.",
};
