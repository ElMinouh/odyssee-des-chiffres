...
const MAT_ZONES = [
 {id:'mat_cp_1', region:'cp', label:'Le Pré Vert', bg:'linear-gradient(135deg,#a8e6cf,#dcedc1)', emoji:'🌱', boss:'🐻', bossName:'Gros Nounours', level:'PS', starsReq:0, theme:'standard',
  ...
  steps:[
   {type:'monster', emoji:'🐰', name:'Petit lapin', questions:2, difficulty:'easy'},
   {type:'puzzle', emoji:'🧺', name:'Le panier', questions:3, difficulty:'easy'},
   {type:'monster', emoji:'🐤', name:'Poussin doux', questions:3, difficulty:'medium'},
   {type:'minibss', emoji:'🐮', name:'Vache rigolote', questions:4, difficulty:'medium'},
   {type:'boss', emoji:'🐻', name:'Gros Nounours', questions:4, difficulty:'hard', dropRare:true},
  ]},
 {id:'mat_cp_2', region:'cp', label:'Champ de Pâquerettes', bg:'linear-gradient(135deg,#a8e6cf,#dcedc1)', emoji:'🌼', boss:'🐔', bossName:'Maman Poule', level:'PS', starsReq:45, theme:'standard',
  parallax:{sky:['#b8e0d2','#dcedc1','#fff5d6'], mountains:['#7ab87a','#4a884a'], decor:['🌼','🦋','🍃'], astro:'☀️'},
  steps:[
   {type:'monster', emoji:'🐑', name:'Mouton frisé', questions:2, difficulty:'easy'},
   {type:'puzzle', emoji:'🌷', name:'Les fleurs', questions:3, difficulty:'easy'},
   {type:'monster', emoji:'🐞', name:'Coccinelle', questions:3, difficulty:'medium'},
   {type:'minibss', emoji:'🐷', name:'Cochon joueur', questions:4, difficulty:'medium'},
   {type:'boss', emoji:'🐔', name:'Maman Poule', questions:4, difficulty:'hard', dropRare:true},
  ]},
 {id:'mat_cp_3', region:'cp', label:'La Petite Mare', bg:'linear-gradient(135deg,#a8e6cf,#dcedc1)', emoji:'💧', boss:'🦢', bossName:'Cygne Blanc', level:'PS', starsReq:90, theme:'standard',
  parallax:{sky:['#b8e0d2','#dcedc1','#fff5d6'], mountains:['#7ab87a','#4a884a'], decor:['🌼','🦋','🍃'], astro:'☀️'},
  steps:[
   {type:'monster', emoji:'🦋', name:'Papillon', questions:2, difficulty:'easy'},
   {type:'puzzle', emoji:'🍃', name:'Les feuilles', questions:3, difficulty:'medium'},
   {type:'monster', emoji:'🐌', name:'Escargot lent', questions:3, difficulty:'medium'},
   {type:'minibss', emoji:'🦆', name:'Canard bavard', questions:4, difficulty:'medium'},
   {type:'boss', emoji:'🦢', name:'Cygne Blanc', questions:4, difficulty:'hard', dropRare:true},
  ]},
 {id:'mat_cp_4', region:'cp', label:'Sentier des Câlins', bg:'linear-gradient(135deg,#a8e6cf,#dcedc1)', emoji:'🐾', boss:'🐴', bossName:'Petit Poney', level:'PS', starsReq:135, theme:'standard',
  parallax:{sky:['#b8e0d2','#dcedc1','#fff5d6'], mountains:['#7ab87a','#4a884a'], decor:['🌼','🦋','🍃'], astro:'☀️'},
  steps:[
   {type:'monster', emoji:'🐸', name:'Grenouille', questions:2, difficulty:'easy'},
   {type:'puzzle', emoji:'🎈', name:'Les ballons', questions:3, difficulty:'medium'},
   {type:'monster', emoji:'🐹', name:'Hamster', questions:3, difficulty:'medium'},
   {type:'minibss', emoji:'🐮', name:'Vache rigolote', questions:4, difficulty:'hard'},
   {type:'boss', emoji:'🐴', name:'Petit Poney', questions:4, difficulty:'hard', dropRare:true},
  ]},
 {id:'mat_cp_5', region:'cp', label:'Colline Arc-en-ciel', bg:'linear-gradient(135deg,#a8e6cf,#dcedc1)', emoji:'🌈', boss:'🦄', bossName:'Doux Licorne', level:'PS', starsReq:180, theme:'standard',
  ...
  steps:[
   {type:'monster', emoji:'🐰', name:'Petit lapin', questions:2, difficulty:'easy'},
   {type:'puzzle', emoji:'🧩', name:'Le puzzle doux', questions:3, difficulty:'medium'},
   {type:'monster', emoji:'🐤', name:'Poussin doux', questions:3, difficulty:'medium'},
   {type:'minibss', emoji:'🐷', name:'Cochon joueur', questions:4, difficulty:'hard'},
   {type:'boss', emoji:'🦄', name:'Doux Licorne', questions:4, difficulty:'hard', dropRare:true},
  ]},
 {id:'mat_ce1_1', region:'ce1', label:'Le Verger Sucré', bg:'linear-gradient(135deg,#ffd6e8,#ffe5b4)', emoji:'🍎', boss:'🐻', bossName:'Ourson Gourmand', level:'PS', starsReq:250, theme:'sakura',
  ...
  steps:[
   ...
   {type:'puzzle', emoji:'🍓', name:'Les fraises', questions:3, difficulty:'easy'},
   {type:'monster', emoji:'🐛', name:'Chenille', questions:3, difficulty:'medium'},
   {type:'minibss', emoji:'🦆', name:'Cane maline', questions:4, difficulty:'medium'},
   {type:'boss', emoji:'🐻', name:'Ourson Gourmand', questions:4, difficulty:'hard', dropRare:true},
  ]},
 {id:'mat_ce1_2', region:'ce1', label:'Buisson de Fraises', bg:'linear-gradient(135deg,#ffd6e8,#ffe5b4)', emoji:'🍓', boss:'🦊', bossName:'Renardeau', level:'PS', starsReq:295, theme:'sakura',
  parallax:{sky:['#ffe5b4','#ffd6e8','#fff5d6'], mountains:['#c98aa0','#9b5e72'], decor:['🍓','🍎','🌸'], astro:'🌈'},
  steps:[
   {type:'monster', emoji:'🐿️', name:'Écureuil', questions:2, difficulty:'easy'},
   {type:'puzzle', emoji:'🍯', name:'Le pot de miel', questions:3, difficulty:'easy'},
   {type:'monster', emoji:'🦔', name:'Hérisson', questions:3, difficulty:'medium'},
   {type:'minibss', emoji:'🐢', name:'Tortue lente', questions:4, difficulty:'medium'},
   {type:'boss', emoji:'🦊', name:'Renardeau', questions:4, difficulty:'hard', dropRare:true},
  ]},
 {id:'mat_ce1_3', region:'ce1', label:'Le Rucher Doré', bg:'linear-gradient(135deg,#ffd6e8,#ffe5b4)', emoji:'🍯', boss:'🐝', bossName:'Reine Abeille', level:'PS', starsReq:340, theme:'sakura',
  parallax:{sky:['#ffe5b4','#ffd6e8','#fff5d6'], mountains:['#c98aa0','#9b5e72'], decor:['🍓','🍎','🌸'], astro:'🌈'},
  steps:[
   {type:'monster', emoji:'🐤', name:'Caneton', questions:2, difficulty:'easy'},
   {type:'puzzle', emoji:'🌰', name:'Les noisettes', questions:3, difficulty:'medium'},
   {type:'monster', emoji:'🐰', name:'Lapinou', questions:3, difficulty:'medium'},
   {type:'minibss', emoji:'🐔', name:'Coq matinal', questions:4, difficulty:'medium'},
   {type:'boss', emoji:'🐝', name:'Reine Abeille', questions:4, difficulty:'hard', dropRare:true},
  ]},
 {id:'mat_ce1_4', region:'ce1', label:'Allée des Noisettes', bg:'linear-gradient(135deg,#ffd6e8,#ffe5b4)', emoji:'🌰', boss:'🐿️', bossName:'Roi Écureuil', level:'PS', starsReq:385, theme:'sakura',
  parallax:{sky:['#ffe5b4','#ffd6e8','#fff5d6'], mountains:['#c98aa0','#9b5e72'], decor:['🍓','🍎','🌸'], astro:'🌈'},
  steps:[
   {type:'monster', emoji:'🦋', name:'Papillon rose', questions:2, difficulty:'easy'},
   {type:'puzzle', emoji:'🧺', name:'La cueillette', questions:3, difficulty:'medium'},
   {type:'monster', emoji:'🐞', name:'Bête à bon Dieu', questions:3, difficulty:'medium'},
   {type:'minibss', emoji:'🦆', name:'Cane maline', questions:4, difficulty:'hard'},
   {type:'boss', emoji:'🐿️', name:'Roi Écureuil', questions:4, difficulty:'hard', dropRare:true},
  ]},
 {id:'mat_ce1_5', region:'ce1', label:'Jardin Fleuri', bg:'linear-gradient(135deg,#ffd6e8,#ffe5b4)', emoji:'🌸', boss:'🦋', bossName:'Papillon Géant', level:'PS', starsReq:430, theme:'sakura',
  ...
  steps:[
   {type:'monster', emoji:'🐝', name:'Abeille', questions:2, difficulty:'easy'},
   {type:'puzzle', emoji:'🎀', name:'Le ruban', questions:3, difficulty:'medium'},
   {type:'monster', emoji:'🐛', name:'Chenille', questions:3, difficulty:'medium'},
   {type:'minibss', emoji:'🐢', name:'Tortue lente', questions:4, difficulty:'hard'},
   {type:'boss', emoji:'🦋', name:'Papillon Géant', questions:4, difficulty:'hard', dropRare:true},
  ]},
 {id:'mat_ce2_1', region:'ce2', label:'Clairière Mousse', bg:'linear-gradient(135deg,#88d8b0,#c5e99b)', emoji:'🌿', boss:'🦌', bossName:'Faon Timide', level:'MS', starsReq:500, theme:'foret',
  ...
  steps:[
   {type:'monster', emoji:'🦉', name:'Hibou', questions:2, difficulty:'easy'},
   {type:'puzzle', emoji:'🍄', name:'Les champignons', questions:3, difficulty:'easy'},
   {type:'monster', emoji:'🦇', name:'Chauve-souris', questions:3, difficulty:'medium'},
   {type:'minibss', emoji:'🦊', name:'Renard rusé', questions:4, difficulty:'medium'},
   {type:'boss', emoji:'🦌', name:'Faon Timide', questions:4, difficulty:'hard', dropRare:true},
  ]},
 {id:'mat_ce2_2', region:'ce2', label:'Bois des Champignons', bg:'linear-gradient(135deg,#88d8b0,#c5e99b)', emoji:'🍄', boss:'🐗', bossName:'Sanglier Doux', level:'MS', starsReq:545, theme:'foret',
  parallax:{sky:['#c5e99b','#88d8b0','#5ab87a'], mountains:['#3a6c3a','#244824'], decor:['🍄','🌿','🐛'], astro:'🌙'},
  steps:[
   {type:'monster', emoji:'🐗', name:'Marcassin', questions:2, difficulty:'easy'},
   {type:'puzzle', emoji:'🌿', name:'Les herbes', questions:3, difficulty:'easy'},
   {type:'monster', emoji:'🦝', name:'Raton', questions:3, difficulty:'medium'},
   {type:'minibss', emoji:'🐺', name:'Louveteau', questions:4, difficulty:'medium'},
   {type:'boss', emoji:'🐗', name:'Sanglier Doux', questions:4, difficulty:'hard', dropRare:true},
  ]},
 {id:'mat_ce2_3', region:'ce2', label:'Le Vieux Chêne', bg:'linear-gradient(135deg,#88d8b0,#c5e99b)', emoji:'🌳', boss:'🦉', bossName:'Grand-Duc', level:'MS', starsReq:590, theme:'foret',
  parallax:{sky:['#c5e99b','#88d8b0','#5ab87a'], mountains:['#3a6c3a','#244824'], decor:['🍄','🌿','🐛'], astro:'🌙'},
  steps:[
   {type:'monster', emoji:'🦔', name:'Hérisson', questions:2, difficulty:'easy'},
   {type:'puzzle', emoji:'🪵', name:'Le tronc', questions:3, difficulty:'medium'},
   {type:'monster', emoji:'🐿️', name:'Écureuil', questions:3, difficulty:'medium'},
   {type:'minibss', emoji:'🦡', name:'Blaireau', questions:4, difficulty:'medium'},
   {type:'boss', emoji:'🦉', name:'Grand-Duc', questions:4, difficulty:'hard', dropRare:true},
  ]},
 {id:'mat_ce2_4', region:'ce2', label:'Ruisseau Frais', bg:'linear-gradient(135deg,#88d8b0,#c5e99b)', emoji:'💧', boss:'🦦', bossName:'Loutre Joueuse', level:'MS', starsReq:635, theme:'foret',
  parallax:{sky:['#c5e99b','#88d8b0','#5ab87a'], mountains:['#3a6c3a','#244824'], decor:['🍄','🌿','🐛'], astro:'🌙'},
  steps:[
   {type:'monster', emoji:'🐸', name:'Crapaud', questions:2, difficulty:'easy'},
   {type:'puzzle', emoji:'🕸️', name:'La toile', questions:3, difficulty:'medium'},
   {type:'monster', emoji:'🕊️', name:'Colombe', questions:3, difficulty:'medium'},
   {type:'minibss', emoji:'🦊', name:'Renard rusé', questions:4, difficulty:'hard'},
   {type:'boss', emoji:'🦦', name:'Loutre Joueuse', questions:4, difficulty:'hard', dropRare:true},
  ]},
 {id:'mat_ce2_5', region:'ce2', label:'Sous-Bois Étoilé', bg:'linear-gradient(135deg,#88d8b0,#c5e99b)', emoji:'✨', boss:'🦊', bossName:'Renard Argenté', level:'MS', starsReq:680, theme:'foret',
  ...
  steps:[
   {type:'monster', emoji:'🦉', name:'Hibou', questions:2, difficulty:'easy'},
   {type:'puzzle', emoji:'🌰', name:'Les glands', questions:3, difficulty:'medium'},
   {type:'monster', emoji:'🦇', name:'Chauve-souris', questions:3, difficulty:'medium'},
 ...
 {id:'mat_cm1_1', region:'cm1', label:'Plage des Palmiers', bg:'linear-gradient(135deg,#a0e7e5,#b4f8c8)', emoji:'🏖️', boss:'🦀', bossName:'Crabe Câlin', level:'MS', starsReq:750, theme:'ocean',
  ...
  steps:[
   ...
   {type:'puzzle', emoji:'🐚', name:'Les coquillages', questions:3, difficulty:'easy'},
   {type:'monster', emoji:'🦀', name:'Petit crabe', questions:3, difficulty:'medium'},
 ...
 {id:'mat_cm1_2', region:'cm1', label:'Lagon Émeraude', bg:'linear-gradient(135deg,#a0e7e5,#b4f8c8)', emoji:'🌊', boss:'🐢', bossName:'Tortue Sage', level:'MS', starsReq:795, theme:'ocean',
  ...
  steps:[
   ...
   {type:'puzzle', emoji:'🫧', name:'Les bulles', questions:3, difficulty:'easy'},
   {type:'monster', emoji:'🦐', name:'Crevette', questions:3, difficulty:'medium'},
   {type:'minibss', emoji:'🐬', name:'Dauphin', questions:4, difficulty:'medium'},
   {type:'boss', emoji:'🐢', name:'Tortue Sage', questions:4, difficulty:'hard', dropRare:true},
  ]},
 {id:'mat_cm1_3', region:'cm1', label:'Récif Coloré', bg:'linear-gradient(135deg,#a0e7e5,#b4f8c8)', emoji:'🪸', boss:'🐙', bossName:'Poulpe Joyeux', level:'MS', starsReq:840, theme:'ocean',
  parallax:{sky:['#b4f8c8','#a0e7e5','#8ad5ff'], mountains:['#3a8fa0','#1f5c6e'], decor:['🐚','🐠','🫧'], astro:'☀️'},
  steps:[
   {type:'monster', emoji:'🐡', name:'Poisson-lune', questions:2, difficulty:'easy'},
   {type:'puzzle', emoji:'⭐', name:'Les étoiles de mer', questions:3, difficulty:'medium'},
   {type:'monster', emoji:'🐚', name:'Coquillage', questions:3, difficulty:'medium'},
   {type:'minibss', emoji:'🐧', name:'Manchot', questions:4, difficulty:'medium'},
   {type:'boss', emoji:'🐙', name:'Poulpe Joyeux', questions:4, difficulty:'hard', dropRare:true},
  ]},
 {id:'mat_cm1_4', region:'cm1', label:'Grotte aux Bulles', bg:'linear-gradient(135deg,#a0e7e5,#b4f8c8)', emoji:'🫧', boss:'🐬', bossName:'Dauphin Rieur', level:'MS', starsReq:885, theme:'ocean',
  parallax:{sky:['#b4f8c8','#a0e7e5','#8ad5ff'], mountains:['#3a8fa0','#1f5c6e'], decor:['🐚','🐠','🫧'], astro:'☀️'},
  steps:[
   {type:'monster', emoji:'🦑', name:'Calmar', questions:2, difficulty:'easy'},
   {type:'puzzle', emoji:'🪸', name:'Le corail', questions:3, difficulty:'medium'},
   {type:'monster', emoji:'🐢', name:'Tortue', questions:3, difficulty:'medium'},
 ...
 {id:'mat_cm1_5', region:'cm1', label:'Île aux Tortues', bg:'linear-gradient(135deg,#a0e7e5,#b4f8c8)', emoji:'⭐', boss:'🐳', bossName:'Baleineau', level:'MS', starsReq:930, theme:'ocean',
  ...
  steps:[
   {type:'monster', emoji:'🐠', name:'Poisson', questions:2, difficulty:'easy'},
   {type:'puzzle', emoji:'🏖️', name:'Le sable', questions:3, difficulty:'medium'},
   {type:'monster', emoji:'🦀', name:'Petit crabe', questions:3, difficulty:'medium'},
 ...
 {id:'mat_cm2_1', region:'cm2', label:'Champ de Bleuets', bg:'linear-gradient(135deg,#ffd166,#ffe5b4)', emoji:'🌻', boss:'🐝', bossName:'Bourdon Doux', level:'GS', starsReq:1000, theme:'standard',
  ...
  steps:[
   {type:'monster', emoji:'🐝', name:'Abeille', questions:2, difficulty:'easy'},
   {type:'puzzle', emoji:'🌻', name:'Les tournesols', questions:3, difficulty:'easy'},
   {type:'monster', emoji:'🦋', name:'Papillon', questions:3, difficulty:'medium'},
 ...
 {id:'mat_cm2_2', region:'cm2', label:'Le Grand Cerf-Volant', bg:'linear-gradient(135deg,#ffd166,#ffe5b4)', emoji:'🍏', boss:'🦔', bossName:'Hérisson Roi', level:'GS', starsReq:1045, theme:'standard',
  ...
  steps:[
   ...
   {type:'puzzle', emoji:'🍯', name:'Le miel', questions:3, difficulty:'easy'},
   {type:'monster', emoji:'🦗', name:'Grillon', questions:3, difficulty:'medium'},
 ...
 {id:'mat_cm2_3', region:'cm2', label:'Prairie du Ciel', bg:'linear-gradient(135deg,#ffd166,#ffe5b4)', emoji:'🌾', boss:'🐏', bossName:'Bélier Gentil', level:'GS', starsReq:1090, theme:'standard',
  ...
  steps:[
   ...
   {type:'puzzle', emoji:'🌾', name:'Les épis', questions:3, difficulty:'medium'},
   {type:'monster', emoji:'🕷️', name:'Araignée', questions:3, difficulty:'medium'},
 ...
 {id:'mat_cm2_4', region:'cm2', label:'Moulin des Vents', bg:'linear-gradient(135deg,#ffd166,#ffe5b4)', emoji:'🌾', boss:'🦆', bossName:'Oie Blanche', level:'GS', starsReq:1135, theme:'standard',
  ...
  steps:[
   ...
   {type:'puzzle', emoji:'🧮', name:'Le calcul', questions:3, difficulty:'medium'},
   {type:'monster', emoji:'🪲', name:'Scarabée', questions:3, difficulty:'medium'},
 ...
 {id:'mat_cm2_5', region:'cm2', label:'Colline de l\'Horizon', bg:'linear-gradient(135deg,#ffd166,#ffe5b4)', emoji:'🌞', boss:'🐉', bossName:'Gentil Dragonnet', level:'GS', starsReq:1180, theme:'standard',
  ...
  steps:[
   {type:'monster', emoji:'🐝', name:'Abeille', questions:2, difficulty:'easy'},
   {type:'puzzle', emoji:'🔢', name:'Les chiffres', questions:3, difficulty:'medium'},
   {type:'monster', emoji:'🦋', name:'Papillon', questions:3, difficulty:'medium'},
   {type:'minibss', emoji:'🦃', name:'Dindon', questions:4, difficulty:'hard'},
   {type:'boss', emoji:'🐉', name:'Gentil Dragonnet', questions:4, difficulty:'hard', dropRare:true},
  ]},
 {id:'mat_final_1', region:'final', label:'Pont des Étoiles', bg:'linear-gradient(135deg,#b8c6ff,#e0c3fc)', emoji:'🌉', boss:'🦉', bossName:'Chouette Lune', level:'GS', starsReq:1250, theme:'nuit',
  ...
  steps:[
   {type:'monster', emoji:'🦉', name:'Chouette', questions:2, difficulty:'easy'},
   {type:'puzzle', emoji:'⭐', name:'Les étoiles', questions:3, difficulty:'easy'},
   {type:'monster', emoji:'🦇', name:'Chauve-souris', questions:3, difficulty:'medium'},
   {type:'minibss', emoji:'🦄', name:'Licorne', questions:4, difficulty:'medium'},
   {type:'boss', emoji:'🦉', name:'Chouette Lune', questions:4, difficulty:'hard', dropRare:true},
  ]},
 {id:'mat_final_2', region:'final', label:'Nuage Câlin', bg:'linear-gradient(135deg,#b8c6ff,#e0c3fc)', emoji:'☁️', boss:'🐑', bossName:'Mouton Nuage', level:'GS', starsReq:1295, theme:'nuit',
  parallax:{sky:['#e0c3fc','#b8c6ff','#8e9bff'], mountains:['#5a5f8f','#34375c'], decor:['⭐','🌙','✨'], astro:'🌙'},
  steps:[
   {type:'monster', emoji:'🌟', name:'Étoile filante', questions:2, difficulty:'easy'},
   {type:'puzzle', emoji:'🌙', name:'La lune', questions:3, difficulty:'easy'},
   {type:'monster', emoji:'🐈', name:'Chaton noir', questions:3, difficulty:'medium'},
   {type:'minibss', emoji:'🐉', name:'Dragonnet', questions:4, difficulty:'medium'},
   {type:'boss', emoji:'🐑', name:'Mouton Nuage', questions:4, difficulty:'hard', dropRare:true},
  ]},
 {id:'mat_final_3', region:'final', label:'Jardin de Lune', bg:'linear-gradient(135deg,#b8c6ff,#e0c3fc)', emoji:'🌙', boss:'🦊', bossName:'Renard Étoilé', level:'GS', starsReq:1340, theme:'nuit',
  parallax:{sky:['#e0c3fc','#b8c6ff','#8e9bff'], mountains:['#5a5f8f','#34375c'], decor:['⭐','🌙','✨'], astro:'🌙'},
  steps:[
   {type:'monster', emoji:'🦊', name:'Renard de nuit', questions:2, difficulty:'easy'},
   {type:'puzzle', emoji:'🪐', name:'Les planètes', questions:3, difficulty:'medium'},
   {type:'monster', emoji:'🦝', name:'Raton', questions:3, difficulty:'medium'},
   {type:'minibss', emoji:'🦢', name:'Cygne de nuit', questions:4, difficulty:'medium'},
   {type:'boss', emoji:'🦊', name:'Renard Étoilé', questions:4, difficulty:'hard', dropRare:true},
  ]},
 {id:'mat_final_4', region:'final', label:'Tour Scintillante', bg:'linear-gradient(135deg,#b8c6ff,#e0c3fc)', emoji:'🗼', boss:'🧚', bossName:'Petite Fée', level:'GS', starsReq:1385, theme:'nuit',
  parallax:{sky:['#e0c3fc','#b8c6ff','#8e9bff'], mountains:['#5a5f8f','#34375c'], decor:['⭐','🌙','✨'], astro:'🌙'},
  steps:[
   {type:'monster', emoji:'🐰', name:'Lapin lunaire', questions:2, difficulty:'easy'},
   {type:'puzzle', emoji:'🔭', name:'Le télescope', questions:3, difficulty:'medium'},
   {type:'monster', emoji:'🕊️', name:'Colombe', questions:3, difficulty:'medium'},
   {type:'minibss', emoji:'🦄', name:'Licorne', questions:4, difficulty:'hard'},
   {type:'boss', emoji:'🧚', name:'Petite Fée', questions:4, difficulty:'hard', dropRare:true},
  ]},
 {id:'mat_final_5', region:'final', label:'Château des Nuages', bg:'linear-gradient(135deg,#b8c6ff,#e0c3fc)', emoji:'🏰', boss:'🌟', bossName:'Roi des Étoiles', level:'GS', starsReq:1430, theme:'nuit',
  ...
  steps:[
   {type:'monster', emoji:'🦉', name:'Chouette', questions:2, difficulty:'easy'},
   {type:'puzzle', emoji:'💫', name:'Les comètes', questions:3, difficulty:'medium'},
   {type:'monster', emoji:'🦇', name:'Chauve-souris', questions:3, difficulty:'medium'},
   {type:'minibss', emoji:'🐉', name:'Dragonnet', questions:4, difficulty:'hard'},
   {type:'boss', emoji:'🌟', name:'Roi des Étoiles', questions:4, difficulty:'hard', dropRare:true},
  ]},
];
...
const COL_ZONES = [
 {id:'col_cp_1', region:'cp', label:'Le Port des Décimales', bg:'linear-gradient(135deg,#1f618d,#2980b9)', emoji:'⚓', boss:'🐙', bossName:'Gardien des Virgules', level:'6E', starsReq:0, theme:'ocean',
  ...
  steps:[
   {type:'monster', emoji:'🦈', name:'Requin des récifs', questions:3, difficulty:'easy'},
   {type:'puzzle', emoji:'🧭', name:'Énigme du cap', questions:4, difficulty:'easy'},
   {type:'monster', emoji:'🐙', name:'Kraken mineur', questions:5, difficulty:'medium'},
   {type:'minibss', emoji:'🐉', name:'Serpent de mer', questions:5, difficulty:'medium'},
   {type:'boss', emoji:'🐙', name:'Gardien des Virgules', questions:6, difficulty:'hard', dropRare:true},
  ]},
 {id:'col_cp_2', region:'cp', label:'Quai des Marchands', bg:'linear-gradient(135deg,#1f618d,#2980b9)', emoji:'⚖️', boss:'🦈', bossName:'Écumeur Décimal', level:'6E', starsReq:45, theme:'ocean',
  parallax:{sky:['#2980b9','#1f618d','#154360'], mountains:['#0e3a5c','#06223a'], decor:['⚓','🌊','🧭'], astro:'🌅'},
  steps:[
   {type:'monster', emoji:'🦑', name:'Calmar abyssal', questions:3, difficulty:'easy'},
   {type:'puzzle', emoji:'🗺️', name:'Carte décimale', questions:4, difficulty:'easy'},
   {type:'monster', emoji:'🐡', name:'Globe épineux', questions:5, difficulty:'medium'},
   {type:'minibss', emoji:'🦭', name:'Léviathan jeune', questions:5, difficulty:'medium'},
   {type:'boss', emoji:'🦈', name:'Écumeur Décimal', questions:6, difficulty:'hard', dropRare:true},
  ]},
 {id:'col_cp_3', region:'cp', label:'Phare Brisé', bg:'linear-gradient(135deg,#1f618d,#2980b9)', emoji:'🗼', boss:'🦑', bossName:'Spectre du Phare', level:'6E', starsReq:90, theme:'ocean',
  parallax:{sky:['#2980b9','#1f618d','#154360'], mountains:['#0e3a5c','#06223a'], decor:['⚓','🌊','🧭'], astro:'🌅'},
  steps:[
   {type:'monster', emoji:'🦞', name:'Homard cuirassé', questions:3, difficulty:'easy'},
   {type:'puzzle', emoji:'⚓', name:'Les profondeurs', questions:4, difficulty:'medium'},
   {type:'monster', emoji:'🐍', name:'Murène', questions:5, difficulty:'medium'},
   {type:'minibss', emoji:'🐊', name:'Crocodile marin', questions:5, difficulty:'medium'},
   {type:'boss', emoji:'🦑', name:'Spectre du Phare', questions:6, difficulty:'hard', dropRare:true},
  ]},
 {id:'col_cp_4', region:'cp', label:'Récif Trompeur', bg:'linear-gradient(135deg,#1f618d,#2980b9)', emoji:'🪸', boss:'🐊', bossName:'Mâchoire des Bas-fonds', level:'6E', starsReq:135, theme:'ocean',
  parallax:{sky:['#2980b9','#1f618d','#154360'], mountains:['#0e3a5c','#06223a'], decor:['⚓','🌊','🧭'], astro:'🌅'},
  steps:[
   {type:'monster', emoji:'🦀', name:'Crabe-titan', questions:3, difficulty:'easy'},
   {type:'puzzle', emoji:'🧮', name:'Calcul des marées', questions:4, difficulty:'medium'},
   {type:'monster', emoji:'🐠', name:'Banc affamé', questions:5, difficulty:'medium'},
   {type:'minibss', emoji:'🐉', name:'Serpent de mer', questions:5, difficulty:'hard'},
   {type:'boss', emoji:'🐊', name:'Mâchoire des Bas-fonds', questions:6, difficulty:'hard', dropRare:true},
  ]},
 {id:'col_cp_5', region:'cp', label:'Fosse aux Nombres', bg:'linear-gradient(135deg,#1f618d,#2980b9)', emoji:'🌀', boss:'🐉', bossName:'Hydre des Profondeurs', level:'6E', starsReq:180, theme:'ocean',
  ...
  steps:[
   {type:'monster', emoji:'🦈', name:'Requin des récifs', questions:3, difficulty:'easy'},
   {type:'puzzle', emoji:'📐', name:'Relevé du fond', questions:4, difficulty:'medium'},
   {type:'monster', emoji:'🐙', name:'Kraken mineur', questions:5, difficulty:'medium'},
   {type:'minibss', emoji:'🦭', name:'Léviathan jeune', questions:5, difficulty:'hard'},
   {type:'boss', emoji:'🐉', name:'Hydre des Profondeurs', questions:6, difficulty:'hard', dropRare:true},
  ]},
 {id:'col_ce1_1', region:'ce1', label:'Cavernes Fractionnaires', bg:'linear-gradient(135deg,#196f3d,#27ae60)', emoji:'🍰', boss:'🕷️', bossName:'Reine des Parts', level:'6E', starsReq:250, theme:'foret',
  ...
  steps:[
   {type:'monster', emoji:'🕷️', name:'Tisseuse fractale', questions:3, difficulty:'easy'},
   {type:'puzzle', emoji:'🍄', name:'Cercle des fées', questions:4, difficulty:'easy'},
   {type:'monster', emoji:'🐺', name:'Loup sylvestre', questions:5, difficulty:'medium'},
   {type:'minibss', emoji:'🐻', name:'Ours des cavernes', questions:5, difficulty:'medium'},
   {type:'boss', emoji:'🕷️', name:'Reine des Parts', questions:6, difficulty:'hard', dropRare:true},
  ]},
 {id:'col_ce1_2', region:'ce1', label:'Bois des Numérateurs', bg:'linear-gradient(135deg,#196f3d,#27ae60)', emoji:'🌳', boss:'🐺', bossName:'Alpha Sylvestre', level:'6E', starsReq:295, theme:'foret',
  parallax:{sky:['#27ae60','#196f3d','#0e4023'], mountains:['#0b3a1e','#04200f'], decor:['🍄','🌿','🕯️'], astro:'🌒'},
  steps:[
   {type:'monster', emoji:'🦇', name:'Nuée d\'ombres', questions:3, difficulty:'easy'},
   {type:'puzzle', emoji:'🌿', name:'Énigme des lianes', questions:4, difficulty:'easy'},
   {type:'monster', emoji:'🐗', name:'Sanglier furieux', questions:5, difficulty:'medium'},
   {type:'minibss', emoji:'🌳', name:'Tréant', questions:5, difficulty:'medium'},
   {type:'boss', emoji:'🐺', name:'Alpha Sylvestre', questions:6, difficulty:'hard', dropRare:true},
  ]},
 {id:'col_ce1_3', region:'ce1', label:'Sentier Partagé', bg:'linear-gradient(135deg,#196f3d,#27ae60)', emoji:'➗', boss:'👺', bossName:'Troll Diviseur', level:'6E', starsReq:340, theme:'foret',
  parallax:{sky:['#27ae60','#196f3d','#0e4023'], mountains:['#0b3a1e','#04200f'], decor:['🍄','🌿','🕯️'], astro:'🌒'},
  steps:[
   {type:'monster', emoji:'🦂', name:'Scorpion des bois', questions:3, difficulty:'easy'},
   {type:'puzzle', emoji:'🕸️', name:'Toile fractionnaire', questions:4, difficulty:'medium'},
   {type:'monster', emoji:'🐍', name:'Vipère', questions:5, difficulty:'medium'},
   {type:'minibss', emoji:'👺', name:'Gobelin chef', questions:5, difficulty:'medium'},
   {type:'boss', emoji:'👺', name:'Troll Diviseur', questions:6, difficulty:'hard', dropRare:true},
  ]},
 {id:'col_ce1_4', region:'ce1', label:'Grotte aux Échos', bg:'linear-gradient(135deg,#196f3d,#27ae60)', emoji:'🕳️', boss:'🦇', bossName:'Maître des Ombres', level:'6E', starsReq:385, theme:'foret',
  parallax:{sky:['#27ae60','#196f3d','#0e4023'], mountains:['#0b3a1e','#04200f'], decor:['🍄','🌿','🕯️'], astro:'🌒'},
  steps:[
   {type:'monster', emoji:'🦉', name:'Strige', questions:3, difficulty:'easy'},
   {type:'puzzle', emoji:'🪵', name:'Le tronc partagé', questions:4, difficulty:'medium'},
   {type:'monster', emoji:'🐜', name:'Légion grouillante', questions:5, difficulty:'medium'},
   {type:'minibss', emoji:'🐻', name:'Ours des cavernes', questions:5, difficulty:'hard'},
   {type:'boss', emoji:'🦇', name:'Maître des Ombres', questions:6, difficulty:'hard', dropRare:true},
  ]},
 {id:'col_ce1_5', region:'ce1', label:'Cœur de la Forêt', bg:'linear-gradient(135deg,#196f3d,#27ae60)', emoji:'💚', boss:'🐉', bossName:'Dragon des Fractions', level:'6E', starsReq:430, theme:'foret',
  ...
  steps:[
   {type:'monster', emoji:'🕷️', name:'Tisseuse fractale', questions:3, difficulty:'easy'},
   {type:'puzzle', emoji:'🔮', name:'Rune sylvestre', questions:4, difficulty:'medium'},
   {type:'monster', emoji:'🐺', name:'Loup sylvestre', questions:5, difficulty:'medium'},
   {type:'minibss', emoji:'🌳', name:'Tréant', questions:5, difficulty:'hard'},
   {type:'boss', emoji:'🐉', name:'Dragon des Fractions', questions:6, difficulty:'hard', dropRare:true},
  ]},
 {id:'col_ce2_1', region:'ce2', label:'Plateau des Relatifs', bg:'linear-gradient(135deg,#5d4a8c,#34375c)', emoji:'🌡️', boss:'🧊', bossName:'Sentinelle du Froid', level:'5E', starsReq:500, theme:'nuit',
  ...
  steps:[
   {type:'monster', emoji:'🧊', name:'Golem de givre', questions:3, difficulty:'easy'},
   {type:'puzzle', emoji:'❄️', name:'Énigme du gel', questions:4, difficulty:'easy'},
   {type:'monster', emoji:'👻', name:'Spectre négatif', questions:5, difficulty:'medium'},
   {type:'minibss', emoji:'🐉', name:'Wyverne de glace', questions:5, difficulty:'medium'},
   {type:'boss', emoji:'🧊', name:'Sentinelle du Froid', questions:6, difficulty:'hard', dropRare:true},
  ]},
 {id:'col_ce2_2', region:'ce2', label:'Faille Négative', bg:'linear-gradient(135deg,#5d4a8c,#34375c)', emoji:'➖', boss:'👻', bossName:'Ombre du Moins', level:'5E', starsReq:545, theme:'nuit',
  parallax:{sky:['#5d4a8c','#34375c','#1a1c2c'], mountains:['#16182a','#0a0b16'], decor:['❄️','➕','➖'], astro:'🌑'},
  steps:[
   {type:'monster', emoji:'🐺', name:'Loup polaire', questions:3, difficulty:'easy'},
   {type:'puzzle', emoji:'🌡️', name:'Sous zéro', questions:4, difficulty:'easy'},
   {type:'monster', emoji:'🦅', name:'Aigle des cimes', questions:5, difficulty:'medium'},
   {type:'minibss', emoji:'🗿', name:'Colosse runique', questions:5, difficulty:'medium'},
   {type:'boss', emoji:'👻', name:'Ombre du Moins', questions:6, difficulty:'hard', dropRare:true},
  ]},
 {id:'col_ce2_3', region:'ce2', label:'Crête des Signes', bg:'linear-gradient(135deg,#5d4a8c,#34375c)', emoji:'➕', boss:'🦅', bossName:'Roc des Sommets', level:'5E', starsReq:590, theme:'nuit',
  parallax:{sky:['#5d4a8c','#34375c','#1a1c2c'], mountains:['#16182a','#0a0b16'], decor:['❄️','➕','➖'], astro:'🌑'},
  steps:[
   {type:'monster', emoji:'🐻‍❄️', name:'Ours blanc', questions:3, difficulty:'easy'},
   {type:'puzzle', emoji:'⚖️', name:'Balance des signes', questions:4, difficulty:'medium'},
   {type:'monster', emoji:'🦬', name:'Bison des neiges', questions:5, difficulty:'medium'},
   {type:'minibss', emoji:'👹', name:'Ogre des pics', questions:5, difficulty:'medium'},
   {type:'boss', emoji:'🦅', name:'Roc des Sommets', questions:6, difficulty:'hard', dropRare:true},
  ]},
 {id:'col_ce2_4', region:'ce2', label:'Glacier Gradué', bg:'linear-gradient(135deg,#5d4a8c,#34375c)', emoji:'🧭', boss:'🐉', bossName:'Wyverne Polaire', level:'5E', starsReq:635, theme:'nuit',
  parallax:{sky:['#5d4a8c','#34375c','#1a1c2c'], mountains:['#16182a','#0a0b16'], decor:['❄️','➕','➖'], astro:'🌑'},
  steps:[
   {type:'monster', emoji:'🦂', name:'Scorpion gelé', questions:3, difficulty:'easy'},
   {type:'puzzle', emoji:'🧭', name:'Axe gradué', questions:4, difficulty:'medium'},
   {type:'monster', emoji:'🕷️', name:'Veuve glacée', questions:5, difficulty:'medium'},
   {type:'minibss', emoji:'🐉', name:'Wyverne de glace', questions:5, difficulty:'hard'},
   {type:'boss', emoji:'🐉', name:'Wyverne Polaire', questions:6, difficulty:'hard', dropRare:true},
  ]},
 {id:'col_ce2_5', region:'ce2', label:'Pic du Zéro', bg:'linear-gradient(135deg,#5d4a8c,#34375c)', emoji:'⛰️', boss:'👹', bossName:'Titan de l\'Abîme', level:'5E', starsReq:680, theme:'nuit',
  ...
  steps:[
   {type:'monster', emoji:'🧊', name:'Golem de givre', questions:3, difficulty:'easy'},
   {type:'puzzle', emoji:'🔢', name:'Droite relative', questions:4, difficulty:'medium'},
   {type:'monster', emoji:'👻', name:'Spectre négatif', questions:5, difficulty:'medium'},
   {type:'minibss', emoji:'🗿', name:'Colosse runique', questions:5, difficulty:'hard'},
   {type:'boss', emoji:'👹', name:'Titan de l\'Abîme', questions:6, difficulty:'hard', dropRare:true},
  ]},
 {id:'col_cm1_1', region:'cm1', label:'Citadelle Algébrique', bg:'linear-gradient(135deg,#6c4f2e,#a07d4a)', emoji:'🏰', boss:'🤖', bossName:'Gardien des Inconnues', level:'4E', starsReq:750, theme:'chateau',
  ...
  steps:[
   {type:'monster', emoji:'🤖', name:'Automate algébrique', questions:3, difficulty:'easy'},
   {type:'puzzle', emoji:'📜', name:'Énigme du parchemin', questions:4, difficulty:'easy'},
   {type:'monster', emoji:'🛡️', name:'Garde de pierre', questions:5, difficulty:'medium'},
   {type:'minibss', emoji:'🐉', name:'Dragon de garde', questions:5, difficulty:'medium'},
   {type:'boss', emoji:'🤖', name:'Gardien des Inconnues', questions:6, difficulty:'hard', dropRare:true},
  ]},
 {id:'col_cm1_2', region:'cm1', label:'Salle des Variables', bg:'linear-gradient(135deg,#6c4f2e,#a07d4a)', emoji:'🔣', boss:'🐲', bossName:'Gargouille Littérale', level:'4E', starsReq:795, theme:'chateau',
  parallax:{sky:['#a07d4a','#6c4f2e','#3a2a18'], mountains:['#2a1f12','#150f08'], decor:['📜','⚙️','🗝️'], astro:'🌗'},
  steps:[
   {type:'monster', emoji:'🐲', name:'Gargouille', questions:3, difficulty:'easy'},
   {type:'puzzle', emoji:'⚙️', name:'Mécanisme inconnu', questions:4, difficulty:'easy'},
   {type:'monster', emoji:'⚔️', name:'Spectre d\'acier', questions:5, difficulty:'medium'},
   {type:'minibss', emoji:'🗿', name:'Golem runique', questions:5, difficulty:'medium'},
   {type:'boss', emoji:'🐲', name:'Gargouille Littérale', questions:6, difficulty:'hard', dropRare:true},
  ]},
 {id:'col_cm1_3', region:'cm1', label:'Forge des Identités', bg:'linear-gradient(135deg,#6c4f2e,#a07d4a)', emoji:'⚒️', boss:'🛡️', bossName:'Colosse Remarquable', level:'4E', starsReq:840, theme:'chateau',
  parallax:{sky:['#a07d4a','#6c4f2e','#3a2a18'], mountains:['#2a1f12','#150f08'], decor:['📜','⚙️','🗝️'], astro:'🌗'},
  steps:[
   {type:'monster', emoji:'🕯️', name:'Liche mineure', questions:3, difficulty:'easy'},
   {type:'puzzle', emoji:'🗝️', name:'Serrure littérale', questions:4, difficulty:'medium'},
   {type:'monster', emoji:'🦅', name:'Aigle héraldique', questions:5, difficulty:'medium'},
   {type:'minibss', emoji:'👺', name:'Champion noir', questions:5, difficulty:'medium'},
   {type:'boss', emoji:'🛡️', name:'Colosse Remarquable', questions:6, difficulty:'hard', dropRare:true},
  ]},
 {id:'col_cm1_4', region:'cm1', label:'Bibliothèque Secrète', bg:'linear-gradient(135deg,#6c4f2e,#a07d4a)', emoji:'📚', boss:'🕯️', bossName:'Liche des Équations', level:'4E', starsReq:885, theme:'chateau',
  parallax:{sky:['#a07d4a','#6c4f2e','#3a2a18'], mountains:['#2a1f12','#150f08'], decor:['📜','⚙️','🗝️'], astro:'🌗'},
  steps:[
   {type:'monster', emoji:'🐍', name:'Basilic', questions:3, difficulty:'easy'},
   {type:'puzzle', emoji:'🔣', name:'Glyphe variable', questions:4, difficulty:'medium'},
   {type:'monster', emoji:'👤', name:'Assassin masqué', questions:5, difficulty:'medium'},
   {type:'minibss', emoji:'🐉', name:'Dragon de garde', questions:5, difficulty:'hard'},
   {type:'boss', emoji:'🕯️', name:'Liche des Équations', questions:6, difficulty:'hard', dropRare:true},
  ]},
 {id:'col_cm1_5', region:'cm1', label:'Donjon du Calcul', bg:'linear-gradient(135deg,#6c4f2e,#a07d4a)', emoji:'🗝️', boss:'🐉', bossName:'Dragon Algébrique', level:'4E', starsReq:930, theme:'chateau',
  ...
  steps:[
   {type:'monster', emoji:'🤖', name:'Automate algébrique', questions:3, difficulty:'easy'},
   {type:'puzzle', emoji:'⚖️', name:'Équilibre des x', questions:4, difficulty:'medium'},
   {type:'monster', emoji:'🛡️', name:'Garde de pierre', questions:5, difficulty:'medium'},
   {type:'minibss', emoji:'🗿', name:'Golem runique', questions:5, difficulty:'hard'},
   {type:'boss', emoji:'🐉', name:'Dragon Algébrique', questions:6, difficulty:'hard', dropRare:true},
  ]},
 {id:'col_cm2_1', region:'cm2', label:'Gorges de Pythagore', bg:'linear-gradient(135deg,#8b0000,#c0392b)', emoji:'📐', boss:'🔥', bossName:'Gardien des Hypoténuses', level:'4E', starsReq:1000, theme:'volcan',
  ...
  steps:[
   {type:'monster', emoji:'🔥', name:'Élémentaire de feu', questions:3, difficulty:'easy'},
   {type:'puzzle', emoji:'🔺', name:'Énigme du triangle', questions:4, difficulty:'easy'},
   {type:'monster', emoji:'🦂', name:'Scorpion de lave', questions:5, difficulty:'medium'},
   {type:'minibss', emoji:'🐉', name:'Dragon de magma', questions:5, difficulty:'medium'},
   {type:'boss', emoji:'🔥', name:'Gardien des Hypoténuses', questions:6, difficulty:'hard', dropRare:true},
  ]},
 {id:'col_cm2_2', region:'cm2', label:'Crête des Carrés', bg:'linear-gradient(135deg,#8b0000,#c0392b)', emoji:'🟥', boss:'🦂', bossName:'Scorpion Géomètre', level:'4E', starsReq:1045, theme:'volcan',
  parallax:{sky:['#c0392b','#8b0000','#3a0000'], mountains:['#2a0000','#120000'], decor:['🔺','🪨','🔥'], astro:'🌋'},
  steps:[
   {type:'monster', emoji:'🐲', name:'Drake rouge', questions:3, difficulty:'easy'},
   {type:'puzzle', emoji:'📐', name:'Angle droit caché', questions:4, difficulty:'easy'},
   {type:'monster', emoji:'🗿', name:'Colosse obsidienne', questions:5, difficulty:'medium'},
   {type:'minibss', emoji:'🗿', name:'Titan de roche', questions:5, difficulty:'medium'},
   {type:'boss', emoji:'🦂', name:'Scorpion Géomètre', questions:6, difficulty:'hard', dropRare:true},
  ]},
 {id:'col_cm2_3', region:'cm2', label:'Pont des Racines', bg:'linear-gradient(135deg,#8b0000,#c0392b)', emoji:'√', boss:'🐲', bossName:'Drake des Diagonales', level:'4E', starsReq:1090, theme:'volcan',
  parallax:{sky:['#c0392b','#8b0000','#3a0000'], mountains:['#2a0000','#120000'], decor:['🔺','🪨','🔥'], astro:'🌋'},
  steps:[
   {type:'monster', emoji:'🦇', name:'Démon ailé', questions:3, difficulty:'easy'},
   {type:'puzzle', emoji:'🪨', name:'Le bloc carré', questions:4, difficulty:'medium'},
   {type:'monster', emoji:'🐍', name:'Salamandre', questions:5, difficulty:'medium'},
   {type:'minibss', emoji:'👺', name:'Seigneur des cendres', questions:5, difficulty:'medium'},
   {type:'boss', emoji:'🐲', name:'Drake des Diagonales', questions:6, difficulty:'hard', dropRare:true},
  ]},
 {id:'col_cm2_4', region:'cm2', label:'Caldeira Brûlante', bg:'linear-gradient(135deg,#8b0000,#c0392b)', emoji:'🌋', boss:'🗿', bossName:'Colosse des Cathètes', level:'4E', starsReq:1135, theme:'volcan',
  parallax:{sky:['#c0392b','#8b0000','#3a0000'], mountains:['#2a0000','#120000'], decor:['🔺','🪨','🔥'], astro:'🌋'},
  steps:[
   {type:'monster', emoji:'👹', name:'Diablotin', questions:3, difficulty:'easy'},
   {type:'puzzle', emoji:'📏', name:'Mesure des côtés', questions:4, difficulty:'medium'},
   {type:'monster', emoji:'🦅', name:'Phénix mineur', questions:5, difficulty:'medium'},
   {type:'minibss', emoji:'🐉', name:'Dragon de magma', questions:5, difficulty:'hard'},
   {type:'boss', emoji:'🗿', name:'Colosse des Cathètes', questions:6, difficulty:'hard', dropRare:true},
  ]},
 {id:'col_cm2_5', region:'cm2', label:'Cœur du Volcan', bg:'linear-gradient(135deg,#8b0000,#c0392b)', emoji:'❤️‍🔥', boss:'🐉', bossName:'Dragon Pythagoricien', level:'4E', starsReq:1180, theme:'volcan',
  ...
  steps:[
   {type:'monster', emoji:'🔥', name:'Élémentaire de feu', questions:3, difficulty:'easy'},
   {type:'puzzle', emoji:'🧭', name:'Trace de Pythagore', questions:4, difficulty:'medium'},
   {type:'monster', emoji:'🦂', name:'Scorpion de lave', questions:5, difficulty:'medium'},
   {type:'minibss', emoji:'🗿', name:'Titan de roche', questions:5, difficulty:'hard'},
   {type:'boss', emoji:'🐉', name:'Dragon Pythagoricien', questions:6, difficulty:'hard', dropRare:true},
  ]},
 {id:'col_final_1', region:'final', label:'Observatoire des Fonctions', bg:'linear-gradient(135deg,#1a0530,#3a0a4a)', emoji:'🔭', boss:'🛸', bossName:'Gardien des Courbes', level:'3E', starsReq:1250, theme:'nuit',
  ...
  steps:[
   {type:'monster', emoji:'🛸', name:'Sentinelle céleste', questions:3, difficulty:'easy'},
   {type:'puzzle', emoji:'📈', name:'Énigme de la courbe', questions:4, difficulty:'easy'},
   {type:'monster', emoji:'🌌', name:'Spectre cosmique', questions:5, difficulty:'medium'},
   {type:'minibss', emoji:'🐉', name:'Dragon stellaire', questions:5, difficulty:'medium'},
   {type:'boss', emoji:'🛸', name:'Gardien des Courbes', questions:6, difficulty:'hard', dropRare:true},
  ]},
 {id:'col_final_2', region:'final', label:'Nébuleuse Affine', bg:'linear-gradient(135deg,#1a0530,#3a0a4a)', emoji:'📈', boss:'🌌', bossName:'Spectre Linéaire', level:'3E', starsReq:1295, theme:'nuit',
  parallax:{sky:['#3a0a4a','#1a0530','#0a0014'], mountains:['#08001a','#000000'], decor:['📈','✨','🪐'], astro:'🌌'},
  steps:[
   {type:'monster', emoji:'🪐', name:'Gardien orbital', questions:3, difficulty:'easy'},
   {type:'puzzle', emoji:'📉', name:'Pente cachée', questions:4, difficulty:'easy'},
   {type:'monster', emoji:'⭐', name:'Astre déchu', questions:5, difficulty:'medium'},
   {type:'minibss', emoji:'🗿', name:'Colosse galactique', questions:5, difficulty:'medium'},
   {type:'boss', emoji:'🌌', name:'Spectre Linéaire', questions:6, difficulty:'hard', dropRare:true},
  ]},
 {id:'col_final_3', region:'final', label:'Champ des Images', bg:'linear-gradient(135deg,#1a0530,#3a0a4a)', emoji:'🪞', boss:'🪐', bossName:'Titan des Antécédents', level:'3E', starsReq:1340, theme:'nuit',
  parallax:{sky:['#3a0a4a','#1a0530','#0a0014'], mountains:['#08001a','#000000'], decor:['📈','✨','🪐'], astro:'🌌'},
  steps:[
   {type:'monster', emoji:'🌀', name:'Vortex vivant', questions:3, difficulty:'easy'},
   {type:'puzzle', emoji:'🧮', name:'Calcul des images', questions:4, difficulty:'medium'},
   {type:'monster', emoji:'👁️', name:'Œil du vide', questions:5, difficulty:'medium'},
   {type:'minibss', emoji:'👹', name:'Ombre du néant', questions:5, difficulty:'medium'},
   {type:'boss', emoji:'🪐', name:'Titan des Antécédents', questions:6, difficulty:'hard', dropRare:true},
  ]},
 {id:'col_final_4', region:'final', label:'Spirale du Calcul', bg:'linear-gradient(135deg,#1a0530,#3a0a4a)', emoji:'🌀', boss:'☄️', bossName:'Comète des Équations', level:'3E', starsReq:1385, theme:'nuit',
  parallax:{sky:['#3a0a4a','#1a0530','#0a0014'], mountains:['#08001a','#000000'], decor:['📈','✨','🪐'], astro:'🌌'},
  steps:[
   {type:'monster', emoji:'☄️', name:'Comète furieuse', questions:3, difficulty:'easy'},
   {type:'puzzle', emoji:'🔢', name:'Antécédent perdu', questions:4, difficulty:'medium'},
   {type:'monster', emoji:'🔭', name:'Veilleur stellaire', questions:5, difficulty:'medium'},
   {type:'minibss', emoji:'🐉', name:'Dragon stellaire', questions:5, difficulty:'hard'},
   {type:'boss', emoji:'☄️', name:'Comète des Équations', questions:6, difficulty:'hard', dropRare:true},
  ]},
 {id:'col_final_5', region:'final', label:'Sanctuaire Stellaire', bg:'linear-gradient(135deg,#1a0530,#3a0a4a)', emoji:'⛩️', boss:'🐉', bossName:'Souverain des Fonctions', level:'3E', starsReq:1430, theme:'nuit',
  ...
  steps:[
   {type:'monster', emoji:'🛸', name:'Sentinelle céleste', questions:3, difficulty:'easy'},
   {type:'puzzle', emoji:'📐', name:'Repère brisé', questions:4, difficulty:'medium'},
   {type:'monster', emoji:'🌌', name:'Spectre cosmique', questions:5, difficulty:'medium'},
